...
double func(double u, double exponent) { return pow(u, exponent); }
...
void degree_of_polynomial(const int repro) {
  ...
  spinor *ss = NULL, *ss_ = NULL, *auxs = NULL, *auxs_ = NULL, *aux2s = NULL, *aux2s_ = NULL,
         *aux3s = NULL, *aux3s_ = NULL;
  spinor *sc = NULL, *sc_ = NULL, *auxc = NULL, *auxc_ = NULL, *aux2c = NULL, *aux2c_ = NULL,
         *aux3c = NULL, *aux3c_ = NULL;
