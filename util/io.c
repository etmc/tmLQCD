...
int read_lime_gauge_field_doubleprec(double *config, char *filename, const int T, const int LX,
...
int read_lime_gauge_field_singleprec(float *config, char *filename, const int T, const int LX,
                                     const int LY, const int LZ) {
  FILE *ifs;
  int t, x, y, z, status, p = 0;
  n_uint64_t bytes;
