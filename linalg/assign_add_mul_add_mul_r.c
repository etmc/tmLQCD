 ...
 *
 *   void assign_add_mul_add_mul_r(spinor * const R,spinor * const S,spinor * const U,const double
 *c1,const double c2)
...
void assign_add_mul_add_mul_r(spinor *const R, spinor *const S, spinor *const U, const double c1,
                              const double c2, const int N) {
  int ix;
  spinor *r, *s, *u;
