...
extern double _FT(ddot)(int* n, double x[], int* incx, double y[], int* incy);
extern void _FT(zdotc)(int* n, _Complex double x[], int* incx, _Complex double y[], int* incy);
...
/* BLAS-1 subroutines */
extern void _FT(daxpy)(int* n, double* a, double x[], int* incx, double y[], int* incy);
...
/* BLAS-2 subroutines */
extern void _FT(dgemv)(char* trans, int* m, int* n, double* alpha, double a[], int* lda, double x[],
                       int* incx, double* beta, double y[], int* incy, int len_trans);

extern void _FT(zgemv)(char* trans, int* m, int* n, _Complex double* alpha, _Complex double a[],
                       int* lda, _Complex double x[], int* incx, _Complex double* beta,
                       _Complex double y[], int* incy, int len_trans);

extern void _FT(cgemv)(char* trans, int* m, int* n, _Complex float* alpha, _Complex float a[],
                       int* lda, _Complex float x[], int* incx, _Complex float* beta,
                       _Complex float y[], int* incy, int len_trans);

/* BLAS-3 subroutines */
extern void _FT(dgemm)(char* transa, char* transb, int* m, int* n, int* k, double* alpha,
                       double a[], int* lda, double b[], int* ldb, double* beta, double c[],
                       int* ldc, int len_transa, int len_transb);
extern void _FT(zgemm)(char* transa, char* transb, int* m, int* n, int* k, _Complex double* alpha,
