...
TEST(vector_add) {
  ...
  if (cabs(phi2.c0 - phi0.c0 - phi1.c0) > EPS || cabs(phi2.c1 - phi0.c1 - phi1.c1) > EPS ||
...
TEST(vector_i_add) {
  ...
  if (cabs(phi2.c0 - phi0.c0 - I * phi1.c0) > EPS || cabs(phi2.c1 - phi0.c1 - I * phi1.c1) > EPS ||
...
TEST(cmplx_times_vector) {
  ...
  if (cabs(phi1.c0 - c * phi0.c0) > EPS || cabs(phi1.c1 - c * phi0.c1) > EPS ||
...
TEST(cmplxcjg_times_vector) {
  ...
  if (cabs(phi1.c0 - conj(c) * phi0.c0) > EPS || cabs(phi1.c1 - conj(c) * phi0.c1) > EPS ||
...
TEST(su3_assign) {
  ...
  if (creal(m2.c00) == 1 && cimag(m2.c00) == 1 && creal(m2.c01) == 0 && cimag(m2.c01) == 0 &&
      creal(m2.c02) == 0 && cimag(m2.c02) == 0 && creal(m2.c10) == 0 && cimag(m2.c10) == 0 &&
      creal(m2.c11) == 1 && cimag(m2.c11) == 1 && creal(m2.c12) == 0 && cimag(m2.c12) == 0 &&
      creal(m2.c20) == 0 && cimag(m2.c20) == 0 && creal(m2.c21) == 0 && cimag(m2.c21) == 0 &&
      creal(m2.c22) == 1 && cimag(m2.c22) == 1)
    test = 1;
