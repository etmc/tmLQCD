...
TEST(sdiff) {
  ...
  if ((snrm - 1.4169700000000000e+03) > EPS || (creal(Q[0].s0.c0) + 2.2) > EPS ||
      (cimag(Q[1].s2.c1 + 10.6) > EPS))
    test = 1;
...
TEST(aaddm_r) {
  ...
  if ((snrm / 1000. - 1.3049770963199999) > EPS ||
      (creal(R[0].s0.c0) * 10 + 2.6840000000000003) > EPS ||
      (cimag(R[1].s2.c1) * 10 - 4.6280000000000010) > EPS)
    test = 1;
...
TEST(amadd_r) {
  ...
  if ((snrm / 1000. - 1.2045408500799999) > EPS ||
      (creal(R[0].s0.c0) * 10 - 2.6840000000000003) > EPS ||
      (cimag(R[1].s2.c1) - 3.0491999999999999) > EPS)
    test = 1;
