...
TEST(qpx_algebra) {
  ...
  vec_store2(&phi4, &r[6]);
  vec_store2(&phi5, &r[9]);
  if (cabs(phi4.c0 - phi2.c0) > EPS || cabs(phi4.c1 - phi2.c1) > EPS ||
      cabs(phi4.c2 - phi2.c2) > EPS || cabs(phi5.c0 - phi3.c0) > EPS ||
      cabs(phi5.c1 - phi3.c1) > EPS || cabs(phi5.c2 - phi3.c2) > EPS)
    test = 1;
  ...
  if (cabs(phi4.c0 - phi0.c0 - phi1.c0) > EPS || cabs(phi4.c1 - phi0.c1 - phi1.c1) > EPS ||
  ...
  if (cabs(phi4.c0 - k * phi0.c0) > EPS || cabs(phi4.c1 - k * phi0.c1) > EPS ||
      cabs(phi4.c2 - k * phi0.c2) > EPS || cabs(phi5.c0 - k * phi1.c0) > EPS ||
      cabs(phi5.c1 - k * phi1.c1) > EPS || cabs(phi5.c2 - k * phi1.c2) > EPS)
    test = 1;
  ...
  if (cabs(phi4.c0 - conj(k) * phi0.c0) > EPS || cabs(phi4.c1 - conj(k) * phi0.c1) > EPS ||
      cabs(phi4.c2 - conj(k) * phi0.c2) > EPS || cabs(phi5.c0 - conj(k) * phi1.c0) > EPS ||
      cabs(phi5.c1 - conj(k) * phi1.c1) > EPS || cabs(phi5.c2 - conj(k) * phi1.c2) > EPS)
    test = 1;
  ...
  if (cabs(phi4.c0 - phi0.c0 - I * phi1.c0) > EPS || cabs(phi4.c1 - phi0.c1 - I * phi1.c1) > EPS ||
  ...
  if (cabs(temp.s0.c0 - temp2.s0.c0) > EPS || cabs(temp.s0.c1 - temp2.s0.c1) > EPS ||
      cabs(temp.s0.c2 - temp2.s0.c2) > EPS || cabs(temp.s1.c0 - temp2.s1.c0) > EPS ||
      cabs(temp.s1.c1 - temp2.s1.c1) > EPS || cabs(temp.s1.c2 - temp2.s1.c2) > EPS ||
      cabs(temp.s2.c0 - temp2.s2.c0) > EPS || cabs(temp.s2.c1 - temp2.s2.c1) > EPS ||
      cabs(temp.s2.c2 - temp2.s2.c2) > EPS || cabs(temp.s3.c0 - temp2.s3.c0) > EPS ||
      cabs(temp.s3.c1 - temp2.s3.c1) > EPS || cabs(temp.s3.c2 - temp2.s3.c2) > EPS)
    test = 1;
