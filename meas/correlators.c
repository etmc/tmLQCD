 ...
 * where G1 and G2 are 2 gamma matrices from the set {1, gamma5} --> {S,P} (scalar and pseudoscalar current),
 * <S,S>, <S,P>, <P,P> for all the choices of h1 and h2 (see eq. 18 and 20 of https://arxiv.org/pdf/1005.2042.pdf)
 * 
 *
 ******************************************************/
