...
#define _prefetch_halfspinor(addr) \
  __asm__ __volatile__("prefetcht0 %0" : : "m"(*(((char*)(((unsigned long int)(addr)) & ~0x7f)))))

#define _prefetch_nta_halfspinor(addr) \
  __asm__ __volatile__("prefetchnta %0" : : "m"(*(((char*)(((unsigned long int)(addr)) & ~0x7f)))))
...
#define _prefetch_spinor(addr) \
  __asm__ __volatile__(        \
      ...
      "prefetcht0 %2"          \
      :                        \
      : "m"(*(((char*)(addr)))), "m"(*(((char*)(addr)) + 64)), "m"(*(((char*)(addr)) + 128)))
...
#define _prefetch_mom(addr) __asm__ __volatile__("prefetcht0 %0" : : "m"(*(((char*)((addr))))))
...
#define _prefetch_spinor(addr)                                                               \
  __asm__ __volatile__(                                                                      \
      ...
      : "m"(*(((char*)(addr)))), "m"(*(((char*)(addr)) + 32)), "m"(*(((char*)(addr)) + 64)), \
        "m"(*(((char*)(addr)) + 96)), "m"(*(((char*)(addr)) + 128)),                         \
        "m"(*(((char*)(addr)) + 160)))
...
#define _sse_vector_cmplx_mul(c)         \
  __asm__ __volatile__(                  \
      ...
      "addpd %%xmm2, %%xmm5"             \
      :                                  \
      : "m"(creal(c)), "m"(cimag(c)), "m"(_sse_sgn));
...
#define _sse_su3_multiply(u)                                                                \
  __asm__ __volatile__(                                                                     \
      ...
      "addpd %%xmm11, %%xmm5"                                                               \
      :                                                                                     \
      : "m"(creal((u).c00)), "m"(creal((u).c01)), "m"(creal((u).c10)), "m"(creal((u).c12)), \
        "m"(creal((u).c20)), "m"(creal((u).c21)), "m"(creal((u).c02)), "m"(creal((u).c11)), \
        "m"(creal((u).c22)));                                                               \
  __asm__ __volatile__(                                                                     \
      "movsd %0, %%xmm6 \n\t"                                                               \
      "movsd %1, %%xmm7 \n\t"                                                               \
      ...
      "addpd %%xmm14, %%xmm4"                                                               \
      :                                                                                     \
      : "m"(cimag((u).c00)), "m"(cimag((u).c11)), "m"(cimag((u).c22)), "m"(cimag((u).c10)), \
        "m"(cimag((u).c01)), "m"(cimag((u).c20)), "m"(cimag((u).c02)), "m"(cimag((u).c21)), \
        "m"(cimag((u).c12)), "m"(_sse_sgn))
...
#define _sse_su3_inverse_multiply(u)                                                        \
  __asm__ __volatile__(                                                                     \
      ...
      "addpd %%xmm11, %%xmm5"                                                               \
      :                                                                                     \
      : "m"(creal((u).c00)), "m"(creal((u).c10)), "m"(creal((u).c01)), "m"(creal((u).c21)), \
        "m"(creal((u).c02)), "m"(creal((u).c12)), "m"(creal((u).c20)), "m"(creal((u).c11)), \
        "m"(creal((u).c22)));                                                               \
  __asm__ __volatile__(                                                                     \
      "movsd %0, %%xmm6 \n\t"                                                               \
      "movsd %1, %%xmm7 \n\t"                                                               \
      ...
      "addpd %%xmm14, %%xmm4"                                                               \
      :                                                                                     \
      : "m"(cimag((u).c00)), "m"(cimag((u).c11)), "m"(cimag((u).c22)), "m"(cimag((u).c01)), \
        "m"(cimag((u).c10)), "m"(cimag((u).c02)), "m"(cimag((u).c20)), "m"(cimag((u).c12)), \
        "m"(cimag((u).c21)), "m"(_sse_sgn));
// else for ifdef OPTERON
#else
...
#define _sse_su3_times_su3(u3, u1, u2)                   \
  __asm__ __volatile__(                                  \
      ...
      "movapd %2, %%xmm2"                                \
      :                                                  \
      : "m"((u2).c00), "m"((u2).c10), "m"((u2).c20));    \
  _sse_su3_multiply(u1);                                 \
  __asm__ __volatile__(                                  \
      "movapd %%xmm3, %0 \n\t"                           \
      "movapd %%xmm4, %1 \n\t"                           \
      "movapd %%xmm5, %2"                                \
      : "=m"((u3).c00), "=m"((u3).c10), "=m"((u3).c20)); \
  __asm__ __volatile__(                                  \
      "movapd %0, %%xmm0 \n\t"                           \
      "movapd %1, %%xmm1 \n\t"                           \
      "movapd %2, %%xmm2"                                \
      :                                                  \
      : "m"((u2).c01), "m"((u2).c11), "m"((u2).c21));    \
  _sse_su3_multiply(u1);                                 \
  __asm__ __volatile__(                                  \
      "movapd %%xmm3, %0 \n\t"                           \
      "movapd %%xmm4, %1 \n\t"                           \
      "movapd %%xmm5, %2"                                \
      : "=m"((u3).c01), "=m"((u3).c11), "=m"((u3).c21)); \
  __asm__ __volatile__(                                  \
      "movapd %0, %%xmm0 \n\t"                           \
      "movapd %1, %%xmm1 \n\t"                           \
      "movapd %2, %%xmm2"                                \
      :                                                  \
      : "m"((u2).c02), "m"((u2).c12), "m"((u2).c22));    \
  _sse_su3_multiply(u1);                                 \
  __asm__ __volatile__(                                  \
      "movapd %%xmm3, %0 \n\t"                           \
      "movapd %%xmm4, %1 \n\t"                           \
      "movapd %%xmm5, %2"                                \
      : "=m"((u3).c02), "=m"((u3).c12), "=m"((u3).c22));
