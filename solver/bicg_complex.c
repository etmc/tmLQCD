 ...
 *
 *   int bicg_complex(spinor * const, spinor * const, const int, double, matrix_mult,
 *matrix_mult_dagg) BiCG solver
 *
 **************************************************************************/
...
/* P inout (guess for the solving spinor)
   Q input
*/
int bicg_complex(spinor* const P, spinor* const Q, const int max_iter, double eps_sq,
