...
int incr_eigcg(
    ...
    const double eps_sq1, /*(IN) squared tolerance of convergence of the linear system for systems 1
                             till nrhs1*/
    const double eps_sq,  /*(IN) squared tolerance of convergence of the linear system for systems
                             nrhs1+1 till nrhs*/
    double restart_eps_sq,    /*(IN) squared tolerance for restarting CG*/
    const int rand_guess_opt, /*(IN) set to non-zero if you want to use random intitial guess
                                 (volume Gaussian with mean 0)*/
