...
int main(int argc, char *argv[]) {
  ...
  if (g_proc_id == 0) {
    ...
    printf("# The lattice size is %d x %d x %d x %d\n",
           (int) (T * g_nproc_t), (int) (LX * g_nproc_x), (int) (LY * g_nproc_y),
           (int) (g_nproc_z * LZ));
  ...
  convert_lexic_to_eo( /*even */ g_spinor_field[1], /*odd */ g_spinor_field[2], /*full */
                      g_spinor_field[0]);
  ...
  convert_eo_to_lexic( /*full */ g_spinor_field[1], /*even */ g_spinor_field[4], /*odd */
                      g_spinor_field[3]);
  ...
  _initQphix(argc, argv, /* By = */ 8, /* Bz = */ 8, /* Ncores = */ 2, /* Sy = */ 1, /* Sz = */ 1,
             /* PadXY = */ 1, /* PadXYZ = */ 1, /* MinCt = */ 2, /* compress12 = */ 1,
             QPHIX_DOUBLE_PREC);
