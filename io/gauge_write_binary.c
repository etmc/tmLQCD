...
static int write_binary_gauge_data_lime(WRITER * writer, const int prec, DML_Checksum * checksum);
static void write_binary_gauge_data_lemon(WRITER * writer, const int prec, DML_Checksum * checksum);

int write_binary_gauge_data(WRITER * limewriter, const int prec, DML_Checksum * checksum)
{
#ifdef HAVE_LIBLEMON
  write_binary_gauge_data_lemon(writer, prec, checksum);
#else /* HAVE_LIBLEMON */
  write_binary_gauge_data_lime(writer, prec, checksum);
#endif /* HAVE_LIBLEMON */
}

static int write_binary_gauge_data_lime(WRITER * limewriter, const int prec, DML_Checksum * checksum)
{
...
void write_binary_gauge_data_lemon(LemonWriter * lemonwriter, const int prec, DML_Checksum * ans)
{
