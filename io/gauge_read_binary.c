...
static int read_binary_gauge_data_lime(READER * reader, DML_Checksum * checksum);
static void read_binary_gauge_data_lemon(READER * reader, DML_Checksum * checksum);

int read_binary_gauge_data(READER * reader, DML_Checksum * checksum)
{
#ifdef HAVE_LIBLEMON
    return read_binary_gauge_data_lemon(READER * reader, DML_Checksum * checksum);
#else /* HAVE_LIBLEMON */
    return read_binary_gauge_data_lime(READER * reader, DML_Checksum * checksum);
#endif /* HAVE_LIBLEMON */
}


/* Separate functions follow */
