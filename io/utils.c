...
void write_su3(su3* up, FILE* f) {
  fprintf(f, "%f %f %f %f %f %f \n%f %f %f %f %f %f \n%f %f %f %f %f %f %d\n\n", creal(up->c00),
          cimag(up->c00), creal(up->c01), cimag(up->c01), creal(up->c02), cimag(up->c02),
          creal(up->c10), cimag(up->c10), creal(up->c11), cimag(up->c11), creal(up->c12),
          cimag(up->c12), creal(up->c20), cimag(up->c20), creal(up->c21), cimag(up->c21),
