...
void dump_su3(su3 const * up, FILE * f) {
  fprintf(f,"[(%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\n (%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\n (%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)]\n\n",
...
void dump_spinor(spinor const * up, FILE * f) {
  fprintf(f,"[(%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\n (%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\n (%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\n (%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)\t(%+8.6f %+8.6fi)]\n\n",
	     ...
	     creal(up->s2.c0), cimag(up->s2.c0), creal(up->s2.c1), cimag(up->s2.c1), creal(up->s2.c2), cimag(up->s2.c2),
             creal(up->s3.c0), cimag(up->s3.c0), creal(up->s3.c1), cimag(up->s3.c1), creal(up->s3.c2), cimag(up->s3.c2));
}
