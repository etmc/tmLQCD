...
int main(int argc,char *argv[]) {
  ...
  if (g_proc_id == 0){
    printf("Writing Gauge field to file %s in ILDG format single precision...\n", ofilename); fflush(stdout);
  }
  write_lime_gauge_field( ofilename, plaquette_energy/(6.*VOLUME*g_nproc), trajectory_counter, 32);
