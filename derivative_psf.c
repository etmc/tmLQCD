...
#pragma pomp inst begin(derivativepsf)
  ...
  if(even_odd_flag)
  {
    if(nr == 0) 
    {
      ...
      /*
       *  this is being run in case there is no even/odd preconditioning
       */
      if(nr == 1) 
      {
        /*********************************************************************
  ...
  else
  {
    if(nr == 0) 
    {
      ...
      if(ITER_MAX_BCG == 0 || (fabs(g_mu) > 0) || (g_nr_of_psf != nr+1)) 
      {
        ...
        /*spinor *oonnee;
          spinor *ttwwoo;
          oonnee = g_spinor_field[DUM_DERI];
          ttwwoo = g_spinor_field[DUM_DERI+2];
          Q_minus_psi(g_spinor_field[DUM_DERI], g_spinor_field[DUM_DERI+1]);
          Q_plus_psi(g_spinor_field[DUM_DERI+2], g_spinor_field[DUM_DERI]);
          Q_plus_psi(g_spinor_field[DUM_DERI], g_spinor_field[DUM_DERI+1]);
          Q_minus_psi(g_spinor_field[DUM_DERI+3], g_spinor_field[DUM_DERI]);
          for(x=0; x<VOLUME; x++)
          {
          ttmmpp.s0.c0.re = oonnee[x].s0.c0.re - ttwwoo[x].s0.c0.re;
          ttmmpp.s0.c0.im = oonnee[x].s0.c0.im - ttwwoo[x].s0.c0.im;
          ttmmpp.s0.c1.re = oonnee[x].s0.c1.re - ttwwoo[x].s0.c1.re;
          ttmmpp.s0.c1.im = oonnee[x].s0.c1.im - ttwwoo[x].s0.c1.im;
          ttmmpp.s0.c2.re = oonnee[x].s0.c2.re - ttwwoo[x].s0.c2.re;
          ttmmpp.s0.c2.im = oonnee[x].s0.c2.im - ttwwoo[x].s0.c2.im;
          ttmmpp.s1.c0.re = oonnee[x].s1.c0.re - ttwwoo[x].s1.c0.re;
          ttmmpp.s1.c0.im = oonnee[x].s1.c0.im - ttwwoo[x].s1.c0.im;
          ttmmpp.s1.c1.re = oonnee[x].s1.c1.re - ttwwoo[x].s1.c1.re;
          ttmmpp.s1.c1.im = oonnee[x].s1.c1.im - ttwwoo[x].s1.c1.im;
          ttmmpp.s1.c2.re = oonnee[x].s1.c2.re - ttwwoo[x].s1.c2.re;
          ttmmpp.s1.c2.im = oonnee[x].s1.c2.im - ttwwoo[x].s1.c2.im;
          ttmmpp.s2.c0.re = oonnee[x].s2.c0.re - ttwwoo[x].s2.c0.re;
          ttmmpp.s2.c0.im = oonnee[x].s2.c0.im - ttwwoo[x].s2.c0.im;
          ttmmpp.s2.c1.re = oonnee[x].s2.c1.re - ttwwoo[x].s2.c1.re;
          ttmmpp.s2.c1.im = oonnee[x].s2.c1.im - ttwwoo[x].s2.c1.im;
          ttmmpp.s2.c2.re = oonnee[x].s2.c2.re - ttwwoo[x].s2.c2.re;
          ttmmpp.s2.c2.im = oonnee[x].s2.c2.im - ttwwoo[x].s2.c2.im;
          ttmmpp.s3.c0.re = oonnee[x].s3.c0.re - ttwwoo[x].s3.c0.re;
          ttmmpp.s3.c0.im = oonnee[x].s3.c0.im - ttwwoo[x].s3.c0.im;
          ttmmpp.s3.c1.re = oonnee[x].s3.c1.re - ttwwoo[x].s3.c1.re;
          ttmmpp.s3.c1.im = oonnee[x].s3.c1.im - ttwwoo[x].s3.c1.im;
          ttmmpp.s3.c2.re = oonnee[x].s3.c2.re - ttwwoo[x].s3.c2.re;
          ttmmpp.s3.c2.im = oonnee[x].s3.c2.im - ttwwoo[x].s3.c2.im;
          printf("x = %d\n", x);
          print_spinor(&(ttmmpp));
          }*/
        /*#############*/
