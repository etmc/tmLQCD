...
#ifndef HALF
 s3 = tex1Dfetch(spin_tex,6*pos+2);
#else
 s3 = tex1Dfetch(spinhalf_tex2,pos);
 s3.x *= norm; 
 s3.y *= norm; 
 s3.z *= norm;
 s3.w *= norm;
...
#ifndef HALF
 s4 = tex1Dfetch(spin_tex,6*pos+3);
#else
 s4 = tex1Dfetch(spinhalf_tex3,pos);
 s4.x *= norm; 
 s4.y *= norm; 
 s4.z *= norm;
 s4.w *= norm;
...
#ifndef HALF
 s5 = tex1Dfetch(spin_tex,6*pos+4);
#else
 s5 = tex1Dfetch(spinhalf_tex4,pos);
 s5.x *= norm; 
 s5.y *= norm; 
 s5.z *= norm; 
 s5.w *= norm;
...
#ifndef HALF
 s6 = tex1Dfetch(spin_tex,6*pos+5);
#else
 s6 = tex1Dfetch(spinhalf_tex5,pos);
 s6.x *= norm; 
 s6.y *= norm; 
 s6.z *= norm;
 s6.w *= norm;
...
(*(out+1)).z =  ( M[0][0].re*s2.z - M[0][0].im*s2.w ) + ( M[0][1].re*s3.x - M[0][1].im*s3.y ) + ( M[0][2].re*s3.z - M[0][2].im*s3.w );
(*(out+1)).w =  ( M[0][0].re*s2.w + M[0][0].im*s2.z ) + ( M[0][1].re*s3.y + M[0][1].im*s3.x ) + ( M[0][2].re*s3.w + M[0][2].im*s3.z );
(*(out+2)).x = ( M[1][0].re*s2.z - M[1][0].im*s2.w ) + ( M[1][1].re*s3.x - M[1][1].im*s3.y ) + ( M[1][2].re*s3.z - M[1][2].im*s3.w );
(*(out+2)).y =  ( M[1][0].re*s2.w + M[1][0].im*s2.z ) + ( M[1][1].re*s3.y + M[1][1].im*s3.x ) + ( M[1][2].re*s3.w + M[1][2].im*s3.z );
(*(out+2)).z =  ( M[2][0].re*s2.z - M[2][0].im*s2.w ) + ( M[2][1].re*s3.x - M[2][1].im*s3.y ) + ( M[2][2].re*s3.z - M[2][2].im*s3.w );
(*(out+2)).w =  ( M[2][0].re*s2.w + M[2][0].im*s2.z ) + ( M[2][1].re*s3.y + M[2][1].im*s3.x ) + ( M[2][2].re*s3.w + M[2][2].im*s3.z );


(*(out+3)).x =  ( M[0][0].re*s4.x - M[0][0].im*s4.y ) + ( M[0][1].re*s4.z - M[0][1].im*s4.w ) + ( M[0][2].re*s5.x - M[0][2].im*s5.y );
(*(out+3)).y =   ( M[0][0].re*s4.y + M[0][0].im*s4.x ) + ( M[0][1].re*s4.w + M[0][1].im*s4.z ) + ( M[0][2].re*s5.y + M[0][2].im*s5.x );
(*(out+3)).z =  ( M[1][0].re*s4.x - M[1][0].im*s4.y ) + ( M[1][1].re*s4.z - M[1][1].im*s4.w ) + ( M[1][2].re*s5.x - M[1][2].im*s5.y );
(*(out+3)).w =  ( M[1][0].re*s4.y + M[1][0].im*s4.x ) + ( M[1][1].re*s4.w + M[1][1].im*s4.z ) + ( M[1][2].re*s5.y + M[1][2].im*s5.x );
(*(out+4)).x =  ( M[2][0].re*s4.x - M[2][0].im*s4.y ) + ( M[2][1].re*s4.z - M[2][1].im*s4.w ) + ( M[2][2].re*s5.x - M[2][2].im*s5.y );
(*(out+4)).y =  ( M[2][0].re*s4.y + M[2][0].im*s4.x ) + ( M[2][1].re*s4.w + M[2][1].im*s4.z ) + ( M[2][2].re*s5.y + M[2][2].im*s5.x );


(*(out+4)).z =  ( M[0][0].re*s5.z - M[0][0].im*s5.w ) + ( M[0][1].re*s6.x - M[0][1].im*s6.y ) + ( M[0][2].re*s6.z - M[0][2].im*s6.w );
(*(out+4)).w =   ( M[0][0].re*s5.w + M[0][0].im*s5.z ) + ( M[0][1].re*s6.y + M[0][1].im*s6.x ) + ( M[0][2].re*s6.w + M[0][2].im*s6.z );
(*(out+5)).x = ( M[1][0].re*s5.z - M[1][0].im*s5.w ) + ( M[1][1].re*s6.x - M[1][1].im*s6.y ) + ( M[1][2].re*s6.z - M[1][2].im*s6.w );
(*(out+5)).y =  ( M[1][0].re*s5.w + M[1][0].im*s5.z ) + ( M[1][1].re*s6.y + M[1][1].im*s6.x ) + ( M[1][2].re*s6.w + M[1][2].im*s6.z );
(*(out+5)).z =  ( M[2][0].re*s5.z - M[2][0].im*s5.w ) + ( M[2][1].re*s6.x - M[2][1].im*s6.y ) + ( M[2][2].re*s6.z - M[2][2].im*s6.w );
(*(out+5)).w =  ( M[2][0].re*s5.w + M[2][0].im*s5.z ) + ( M[2][1].re*s6.y + M[2][1].im*s6.x ) + ( M[2][2].re*s6.w + M[2][2].im*s6.z );
...
(*(out+0)).x = ( M[0][0].re*(*(s+0*DEVOFF)).x -
                 M[0][0].im*(*(s+0*DEVOFF)).y ) 
             + ( M[0][1].re*(*(s+0*DEVOFF)).z - 
                 M[0][1].im*(*(s+0*DEVOFF)).w ) 
             + ( M[0][2].re*(*(s+1*DEVOFF)).x -
                 M[0][2].im*(*(s+1*DEVOFF)).y );
(*(out+0)).y = ( M[0][0].re*(*(s+0*DEVOFF)).y +
                 M[0][0].im*(*(s+0*DEVOFF)).x ) 
             + ( M[0][1].re*(*(s+0*DEVOFF)).w +
                 M[0][1].im*(*(s+0*DEVOFF)).z ) 
             + ( M[0][2].re*(*(s+1*DEVOFF)).y +
                 M[0][2].im*(*(s+1*DEVOFF)).x );


(*(out+0)).z =  ( M[1][0].re*(*(s+0*DEVOFF)).x -
                  M[1][0].im*(*(s+0*DEVOFF)).y ) 
             +  ( M[1][1].re*(*(s+0*DEVOFF)).z - 
                  M[1][1].im*(*(s+0*DEVOFF)).w ) 
             +  ( M[1][2].re*(*(s+1*DEVOFF)).x -
                  M[1][2].im*(*(s+1*DEVOFF)).y );
(*(out+0)).w =  ( M[1][0].re*(*(s+0*DEVOFF)).y +
                  M[1][0].im*(*(s+0*DEVOFF)).x ) 
             +  ( M[1][1].re*(*(s+0*DEVOFF)).w +
                  M[1][1].im*(*(s+0*DEVOFF)).z ) 
             +  ( M[1][2].re*(*(s+1*DEVOFF)).y + 
                  M[1][2].im*(*(s+1*DEVOFF)).x );


(*(out+1)).x = ( M[2][0].re*(*(s+0*DEVOFF)).x -
                 M[2][0].im*(*(s+0*DEVOFF)).y ) 
             + ( M[2][1].re*(*(s+0*DEVOFF)).z -
                 M[2][1].im*(*(s+0*DEVOFF)).w ) 
             + ( M[2][2].re*(*(s+1*DEVOFF)).x -
                 M[2][2].im*(*(s+1*DEVOFF)).y );
(*(out+1)).y = ( M[2][0].re*(*(s+0*DEVOFF)).y +
                 M[2][0].im*(*(s+0*DEVOFF)).x ) 
             + ( M[2][1].re*(*(s+0*DEVOFF)).w +
                 M[2][1].im*(*(s+0*DEVOFF)).z ) 
             + ( M[2][2].re*(*(s+1*DEVOFF)).y +
                 M[2][2].im*(*(s+1*DEVOFF)).x );


(*(out+1)).z = ( M[0][0].re*(*(s+1*DEVOFF)).z -
                 M[0][0].im*(*(s+1*DEVOFF)).w ) 
             + ( M[0][1].re*(*(s+2*DEVOFF)).x -
                 M[0][1].im*(*(s+2*DEVOFF)).y ) 
             + ( M[0][2].re*(*(s+2*DEVOFF)).z -
                 M[0][2].im*(*(s+2*DEVOFF)).w );
(*(out+1)).w = ( M[0][0].re*(*(s+1*DEVOFF)).w +
                 M[0][0].im*(*(s+1*DEVOFF)).z ) 
             + ( M[0][1].re*(*(s+2*DEVOFF)).y +
                 M[0][1].im*(*(s+2*DEVOFF)).x ) 
             + ( M[0][2].re*(*(s+2*DEVOFF)).w +
                 M[0][2].im*(*(s+2*DEVOFF)).z );


(*(out+2)).x = ( M[1][0].re*(*(s+1*DEVOFF)).z -
                 M[1][0].im*(*(s+1*DEVOFF)).w ) 
             + ( M[1][1].re*(*(s+2*DEVOFF)).x -
                 M[1][1].im*(*(s+2*DEVOFF)).y ) 
             + ( M[1][2].re*(*(s+2*DEVOFF)).z -
                 M[1][2].im*(*(s+2*DEVOFF)).w );
(*(out+2)).y = ( M[1][0].re*(*(s+1*DEVOFF)).w +
                 M[1][0].im*(*(s+1*DEVOFF)).z ) 
             + ( M[1][1].re*(*(s+2*DEVOFF)).y +
                 M[1][1].im*(*(s+2*DEVOFF)).x ) 
             + ( M[1][2].re*(*(s+2*DEVOFF)).w +
                 M[1][2].im*(*(s+2*DEVOFF)).z );


(*(out+2)).z = ( M[2][0].re*(*(s+1*DEVOFF)).z -
                 M[2][0].im*(*(s+1*DEVOFF)).w ) 
             + ( M[2][1].re*(*(s+2*DEVOFF)).x -
                 M[2][1].im*(*(s+2*DEVOFF)).y ) 
             + ( M[2][2].re*(*(s+2*DEVOFF)).z -
                 M[2][2].im*(*(s+2*DEVOFF)).w );
(*(out+2)).w = ( M[2][0].re*(*(s+1*DEVOFF)).w +
                 M[2][0].im*(*(s+1*DEVOFF)).z ) 
             + ( M[2][1].re*(*(s+2*DEVOFF)).y +
                 M[2][1].im*(*(s+2*DEVOFF)).x ) 
             + ( M[2][2].re*(*(s+2*DEVOFF)).w +
                 M[2][2].im*(*(s+2*DEVOFF)).z );
...
(*(out+3)).x = ( M[0][0].re*(*(s+3*DEVOFF)).x -
                 M[0][0].im*(*(s+3*DEVOFF)).y ) 
             + ( M[0][1].re*(*(s+3*DEVOFF)).z -
                 M[0][1].im*(*(s+3*DEVOFF)).w ) 
             + ( M[0][2].re*(*(s+4*DEVOFF)).x -
                 M[0][2].im*(*(s+4*DEVOFF)).y );
(*(out+3)).y = ( M[0][0].re*(*(s+3*DEVOFF)).y +
                 M[0][0].im*(*(s+3*DEVOFF)).x ) 
             + ( M[0][1].re*(*(s+3*DEVOFF)).w +
                 M[0][1].im*(*(s+3*DEVOFF)).z ) 
             + ( M[0][2].re*(*(s+4*DEVOFF)).y +
                 M[0][2].im*(*(s+4*DEVOFF)).x );


(*(out+3)).z = ( M[1][0].re*(*(s+3*DEVOFF)).x -
                 M[1][0].im*(*(s+3*DEVOFF)).y ) 
             + ( M[1][1].re*(*(s+3*DEVOFF)).z -
                 M[1][1].im*(*(s+3*DEVOFF)).w ) 
             + ( M[1][2].re*(*(s+4*DEVOFF)).x -
                 M[1][2].im*(*(s+4*DEVOFF)).y );
(*(out+3)).w = ( M[1][0].re*(*(s+3*DEVOFF)).y +
                 M[1][0].im*(*(s+3*DEVOFF)).x ) 
             + ( M[1][1].re*(*(s+3*DEVOFF)).w +
                 M[1][1].im*(*(s+3*DEVOFF)).z ) 
             + ( M[1][2].re*(*(s+4*DEVOFF)).y +
                 M[1][2].im*(*(s+4*DEVOFF)).x );


(*(out+4)).x = ( M[2][0].re*(*(s+3*DEVOFF)).x -
                 M[2][0].im*(*(s+3*DEVOFF)).y ) 
             + ( M[2][1].re*(*(s+3*DEVOFF)).z -
                 M[2][1].im*(*(s+3*DEVOFF)).w ) 
             + ( M[2][2].re*(*(s+4*DEVOFF)).x -
                 M[2][2].im*(*(s+4*DEVOFF)).y );
(*(out+4)).y = ( M[2][0].re*(*(s+3*DEVOFF)).y +
                 M[2][0].im*(*(s+3*DEVOFF)).x ) 
             + ( M[2][1].re*(*(s+3*DEVOFF)).w +
                 M[2][1].im*(*(s+3*DEVOFF)).z ) 
             + ( M[2][2].re*(*(s+4*DEVOFF)).y +
                 M[2][2].im*(*(s+4*DEVOFF)).x );


(*(out+4)).z = ( M[0][0].re*(*(s+4*DEVOFF)).z -
                 M[0][0].im*(*(s+4*DEVOFF)).w ) 
             + ( M[0][1].re*(*(s+5*DEVOFF)).x - 
                 M[0][1].im*(*(s+5*DEVOFF)).y ) 
             + ( M[0][2].re*(*(s+5*DEVOFF)).z -
                 M[0][2].im*(*(s+5*DEVOFF)).w );
(*(out+4)).w = ( M[0][0].re*(*(s+4*DEVOFF)).w +
                 M[0][0].im*(*(s+4*DEVOFF)).z ) 
             + ( M[0][1].re*(*(s+5*DEVOFF)).y +
                 M[0][1].im*(*(s+5*DEVOFF)).x ) 
             + ( M[0][2].re*(*(s+5*DEVOFF)).w +
                 M[0][2].im*(*(s+5*DEVOFF)).z );


(*(out+5)).x = ( M[1][0].re*(*(s+4*DEVOFF)).z -
                 M[1][0].im*(*(s+4*DEVOFF)).w ) 
             + ( M[1][1].re*(*(s+5*DEVOFF)).x -
                 M[1][1].im*(*(s+5*DEVOFF)).y ) 
             + ( M[1][2].re*(*(s+5*DEVOFF)).z -
                 M[1][2].im*(*(s+5*DEVOFF)).w );
(*(out+5)).y = ( M[1][0].re*(*(s+4*DEVOFF)).w +
                 M[1][0].im*(*(s+4*DEVOFF)).z ) 
             + ( M[1][1].re*(*(s+5*DEVOFF)).y +
                 M[1][1].im*(*(s+5*DEVOFF)).x ) 
             + ( M[1][2].re*(*(s+5*DEVOFF)).w +
                 M[1][2].im*(*(s+5*DEVOFF)).z );


(*(out+5)).z = ( M[2][0].re*(*(s+4*DEVOFF)).z - 
                 M[2][0].im*(*(s+4*DEVOFF)).w ) 
             + ( M[2][1].re*(*(s+5*DEVOFF)).x -
                 M[2][1].im*(*(s+5*DEVOFF)).y ) 
             + ( M[2][2].re*(*(s+5*DEVOFF)).z -
                 M[2][2].im*(*(s+5*DEVOFF)).w );
(*(out+5)).w = ( M[2][0].re*(*(s+4*DEVOFF)).w +
                 M[2][0].im*(*(s+4*DEVOFF)).z ) 
             + ( M[2][1].re*(*(s+5*DEVOFF)).y +
                 M[2][1].im*(*(s+5*DEVOFF)).x ) 
             + ( M[2][2].re*(*(s+5*DEVOFF)).w +
                 M[2][2].im*(*(s+5*DEVOFF)).z );
}
...
void init_blas(int vol){
  ...
  if((cudaerr=cudaMalloc((void **) &dev_blas_redfield, size)) != cudaSuccess){
    if(g_proc_id==0) printf("Error in init_blas(): Memory allocation of reduction field failed. Aborting...\n");
    exit(200);
  ...
  if((cudaerr=cudaMalloc((void **) &dev_blas_sredfield, size)) != cudaSuccess){
    if(g_proc_id==0) printf("Error in init_blas(): Memory allocation of small reduction field failed. Aborting...\n");
    exit(200);
  }   // Allocate array on device
  else{
    #ifndef LOWOUTPUT 
  ...
  if((void*)(blas_sredfield = (float *)malloc(size)) == NULL){
    if(g_proc_id==0) printf("Could not allocate memory for blas small redfield on host. Aborting...\n");
    exit(200);
  } 
...
void convert2double_spin (dev_spinor* spin, spinor* h2d) {
  ...
  for (i = 0; i < Vol; i++) {
        ...
        h2d[i].s0.c0.re = (double) spin[i+0*offset].x;
        h2d[i].s0.c0.im = (double) spin[i+0*offset].y;
        h2d[i].s0.c1.re = (double) spin[i+0*offset].z;
        h2d[i].s0.c1.im = (double) spin[i+0*offset].w;
        
        h2d[i].s0.c2.re = (double) spin[i+1*offset].x;
        h2d[i].s0.c2.im = (double) spin[i+1*offset].y;
        h2d[i].s1.c0.re = (double) spin[i+1*offset].z;
        h2d[i].s1.c0.im = (double) spin[i+1*offset].w;   
        
        h2d[i].s1.c1.re = (double) spin[i+2*offset].x;
        h2d[i].s1.c1.im = (double) spin[i+2*offset].y;
        h2d[i].s1.c2.re = (double) spin[i+2*offset].z;
        h2d[i].s1.c2.im = (double) spin[i+2*offset].w;  
        
        h2d[i].s2.c0.re = (double) spin[i+3*offset].x;
        h2d[i].s2.c0.im = (double) spin[i+3*offset].y;
        h2d[i].s2.c1.re = (double) spin[i+3*offset].z;
        h2d[i].s2.c1.im = (double) spin[i+3*offset].w;  
        
        h2d[i].s2.c2.re = (double) spin[i+4*offset].x;
        h2d[i].s2.c2.im = (double) spin[i+4*offset].y;
        h2d[i].s3.c0.re = (double) spin[i+4*offset].z;
        h2d[i].s3.c0.im = (double) spin[i+4*offset].w; 
        
        h2d[i].s3.c1.re = (double) spin[i+5*offset].x;
        h2d[i].s3.c1.im = (double) spin[i+5*offset].y;
        h2d[i].s3.c2.re = (double) spin[i+5*offset].z;
        h2d[i].s3.c2.im = (double) spin[i+5*offset].w; 
...
void convert2REAL4_spin(spinor* spin, dev_spinor* h2d){
  ...
  for (i = 0; i < Vol; i++) {
        ...
        h2d[i+0*offset].x = (REAL) spin[i].s0.c0.re;
        h2d[i+0*offset].y = (REAL) spin[i].s0.c0.im;
        h2d[i+0*offset].z = (REAL) spin[i].s0.c1.re;
        h2d[i+0*offset].w = (REAL) spin[i].s0.c1.im;
        
        h2d[i+1*offset].x = (REAL) spin[i].s0.c2.re;
        h2d[i+1*offset].y = (REAL) spin[i].s0.c2.im;
        h2d[i+1*offset].z = (REAL) spin[i].s1.c0.re;
        h2d[i+1*offset].w = (REAL) spin[i].s1.c0.im;
        
        h2d[i+2*offset].x = (REAL) spin[i].s1.c1.re;
        h2d[i+2*offset].y = (REAL) spin[i].s1.c1.im;
        h2d[i+2*offset].z = (REAL) spin[i].s1.c2.re;
        h2d[i+2*offset].w = (REAL) spin[i].s1.c2.im;
        
        h2d[i+3*offset].x = (REAL) spin[i].s2.c0.re;
        h2d[i+3*offset].y = (REAL) spin[i].s2.c0.im;
        h2d[i+3*offset].z = (REAL) spin[i].s2.c1.re;
        h2d[i+3*offset].w = (REAL) spin[i].s2.c1.im;
        
        h2d[i+4*offset].x = (REAL) spin[i].s2.c2.re;
        h2d[i+4*offset].y = (REAL) spin[i].s2.c2.im;
        h2d[i+4*offset].z = (REAL) spin[i].s3.c0.re;
        h2d[i+4*offset].w = (REAL) spin[i].s3.c0.im;
        
        h2d[i+5*offset].x = (REAL) spin[i].s3.c1.re;
        h2d[i+5*offset].y = (REAL) spin[i].s3.c1.im;
        h2d[i+5*offset].z = (REAL) spin[i].s3.c2.re;
        h2d[i+5*offset].w = (REAL) spin[i].s3.c2.im;
...
void order_spin_gpu(spinor* spin, dev_spinor_d* h2d){
  ...
  for (i = 0; i < Vol; i++) {
        ...
        h2d[i+0*offset].x = spin[i].s0.c0.re;
        h2d[i+0*offset].y = spin[i].s0.c0.im;
        h2d[i+0*offset].z = spin[i].s0.c1.re;
        h2d[i+0*offset].w = spin[i].s0.c1.im;
        
        h2d[i+1*offset].x = spin[i].s0.c2.re;
        h2d[i+1*offset].y = spin[i].s0.c2.im;
        h2d[i+1*offset].z = spin[i].s1.c0.re;
        h2d[i+1*offset].w = spin[i].s1.c0.im;
        
        h2d[i+2*offset].x = spin[i].s1.c1.re;
        h2d[i+2*offset].y = spin[i].s1.c1.im;
        h2d[i+2*offset].z = spin[i].s1.c2.re;
        h2d[i+2*offset].w = spin[i].s1.c2.im;
        
        h2d[i+3*offset].x = spin[i].s2.c0.re;
        h2d[i+3*offset].y = spin[i].s2.c0.im;
        h2d[i+3*offset].z = spin[i].s2.c1.re;
        h2d[i+3*offset].w = spin[i].s2.c1.im;
        
        h2d[i+4*offset].x = spin[i].s2.c2.re;
        h2d[i+4*offset].y = spin[i].s2.c2.im;
        h2d[i+4*offset].z = spin[i].s3.c0.re;
        h2d[i+4*offset].w = spin[i].s3.c0.im;
        
        h2d[i+5*offset].x = spin[i].s3.c1.re;
        h2d[i+5*offset].y = spin[i].s3.c1.im;
        h2d[i+5*offset].z = spin[i].s3.c2.re;
        h2d[i+5*offset].w = spin[i].s3.c2.im;
...
void unorder_spin_gpu (dev_spinor_d* spin, spinor* h2d) {
  ...
  for (i = 0; i < Vol; i++) {
        ...
        h2d[i].s0.c0.re = spin[i+0*offset].x;
        h2d[i].s0.c0.im = spin[i+0*offset].y;
        h2d[i].s0.c1.re = spin[i+0*offset].z;
        h2d[i].s0.c1.im = spin[i+0*offset].w;
        
        h2d[i].s0.c2.re = spin[i+1*offset].x;
        h2d[i].s0.c2.im = spin[i+1*offset].y;
        h2d[i].s1.c0.re = spin[i+1*offset].z;
        h2d[i].s1.c0.im = spin[i+1*offset].w;   
        
        h2d[i].s1.c1.re = spin[i+2*offset].x;
        h2d[i].s1.c1.im = spin[i+2*offset].y;
        h2d[i].s1.c2.re = spin[i+2*offset].z;
        h2d[i].s1.c2.im = spin[i+2*offset].w;  
        
        h2d[i].s2.c0.re = spin[i+3*offset].x;
        h2d[i].s2.c0.im = spin[i+3*offset].y;
        h2d[i].s2.c1.re = spin[i+3*offset].z;
        h2d[i].s2.c1.im = spin[i+3*offset].w;  
        
        h2d[i].s2.c2.re = spin[i+4*offset].x;
        h2d[i].s2.c2.im = spin[i+4*offset].y;
        h2d[i].s3.c0.re = spin[i+4*offset].z;
        h2d[i].s3.c0.im = spin[i+4*offset].w; 
        
        h2d[i].s3.c1.re = spin[i+5*offset].x;
        h2d[i].s3.c1.im = spin[i+5*offset].y;
        h2d[i].s3.c2.re = spin[i+5*offset].z;
        h2d[i].s3.c2.im = spin[i+5*offset].w; 
