...
#define _vec_add_double_to2(rs0, rs1, rs2, rs3, rs4, rs5, r0, r1, r2, r3, r4, r5, s0, s1, s2, s3, \
                            s4, s5)                                                               \
  (rs0) = vec_add((r0), (s0));                                                                    \
  (rs1) = vec_add((r1), (s1));                                                                    \
  (rs2) = vec_add((r2), (s2));                                                                    \
...
#define _vec_sub_to_double2(rs0, rs1, rs2, rs3, rs4, rs5, r0, r1, r2, r3, r4, r5, s0, s1, s2, s3, \
                            s4, s5)                                                               \
  (rs0) = vec_sub((r0), (s0));                                                                    \
  (rs1) = vec_sub((r1), (s1));                                                                    \
  (rs2) = vec_sub((r2), (s2));                                                                    \
...
#define _vec_i_mul_add_double_to2(rs0, rs1, rs2, rs3, rs4, rs5, r0, r1, r2, r3, r4, r5, s0, s1, \
                                  s2, s3, s4, s5, tmp)                                          \
  tmp = vec_splats(1.);                                                                         \
  rs0 = vec_xxnpmadd(s0, tmp, r0);                                                              \
  rs1 = vec_xxnpmadd(s1, tmp, r1);                                                              \
...
#define _vec_i_mul_sub_double_to2(rs0, rs1, rs2, rs3, rs4, rs5, r0, r1, r2, r3, r4, r5, s0, s1, \
                                  s2, s3, s4, s5, tmp)                                          \
  tmp = vec_splats(-1.);                                                                        \
  rs0 = vec_xxnpmadd(s0, tmp, r0);                                                              \
  rs1 = vec_xxnpmadd(s1, tmp, r1);                                                              \
