...
#define _trace_lambda_mul_add_assign_nonlocal(r, c, a)                   \
  _Pragma("omp atomic")(r).d1 += c * (-cimag((a).c10) - cimag((a).c01)); \
  _Pragma("omp atomic")(r).d2 += c * (+creal((a).c10) - creal((a).c01)); \
  _Pragma("omp atomic")(r).d3 += c * (-cimag((a).c00) + cimag((a).c11)); \
  _Pragma("omp atomic")(r).d4 += c * (-cimag((a).c20) - cimag((a).c02)); \
  _Pragma("omp atomic")(r).d5 += c * (+creal((a).c20) - creal((a).c02)); \
  _Pragma("omp atomic")(r).d6 += c * (-cimag((a).c21) - cimag((a).c12)); \
  _Pragma("omp atomic")(r).d7 += c * (+creal((a).c21) - creal((a).c12)); \
  _Pragma("omp atomic")(r).d8 +=                                         \
      c * ((-cimag((a).c00) - cimag((a).c11) + 2.0 * cimag(a.c22)) * 0.577350269189625);
...
#define _su3adj_square_norm(r)                                                                    \
  (r).d1*(r).d1 + (r).d2*(r).d2 + (r).d3*(r).d3 + (r).d4*(r).d4 + (r).d5*(r).d5 + (r).d6*(r).d6 + \
      (r).d7*(r).d7 + (r).d8*(r).d8;
