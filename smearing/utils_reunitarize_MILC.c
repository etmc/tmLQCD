...
void reunitarize(su3 *omega) {
  ...
  a = 1.0 / sqrt(conj(omega->c00) * omega->c00 + conj(omega->c01) * omega->c01 +
                 conj(omega->c02) * omega->c02);
  ...
  /* now normalize row 1 */
  a = 1.0 / sqrt(conj(omega->c10) * omega->c10 + conj(omega->c11) * omega->c11 +
                 conj(omega->c12) * omega->c12);
