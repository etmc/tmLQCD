...
#define _ADD_AND_REUNITARIZE(x, component)                                             \
  {                                                                                    \
    _real_times_su3_plus_real_times_su3(                                               \
        buff_out[x][component], coeff_principal, buff_in[x][component], coeff_staples, \
        (*staples)[x][component]) reunitarize(buff_out[x] + component);                \
  }
