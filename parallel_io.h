...
#include <lemon/include/lime.h>
#include"dml.h"

int read_lime_gauge_field_parallel(gauge_input_filename);
int read_lime_gauge_field_singleprec_parallel(gauge_input_filename);
...
int write_rlxd_state_parallel(tmp_filename, rlxdsize);
#endif
