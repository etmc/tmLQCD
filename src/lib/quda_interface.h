...
int invert_quda_direct_theta(double* const propgator, double* const source, const int op_id,
...
int invert_eo_quda(spinor* const Even_new, spinor* const Odd_new, spinor* const Even,
                   ...
                   solver_params_t solver_params, const SloppyPrecision sloppy_precision,
...
int invert_doublet_eo_quda(spinor* const Even_new_s, spinor* const Odd_new_s,
                           ...
                           const SloppyPrecision refinement_precision, CompressionType compression);
...
int invert_eo_degenerate_quda(spinor* const Odd_new, spinor* const Odd, const double precision,
                              const int max_iter, const int solver_flag, const int rel_prec,
                              const int even_odd_flag, solver_params_t solver_params,
                              const SloppyPrecision sloppy_precision, CompressionType compression,
                              const int QmQp);

int invert_eo_quda_oneflavour_mshift(spinor** const Odd_new, spinor* const Odd,
