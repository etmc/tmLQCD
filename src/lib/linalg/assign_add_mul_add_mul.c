 ...
 *
 *   void assign_add_mul_add_mul(spinor * const R,spinor * const S,spinor * const U,const _Complex
 *double c1,const _Complex double c2)
...
void assign_add_mul_add_mul(spinor *const R, spinor *const S, spinor *const U,
