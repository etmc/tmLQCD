 ...
 *
 *   void square_and_prod_r(double * const x1, double * const x2, spinor * const S, spinor * const
 *R) Returns the real part of (*R,*S) and the square norm of *S It's faster than using
 *"scalar_prod_r" and "square_norm"
 *
 *******************************************************************************/
