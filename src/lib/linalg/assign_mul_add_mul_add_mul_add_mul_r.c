 ...
 *     (spinor * const R,spinor * const S,spinor * const U,spinor * const V,const double c1,const
 *double c2,const double c3,const double c4) Makes (*R) = c1*(*R) + c2*(*S) + c3*(*U) + c4*(*V)with
 *c1, c2, c3, c4 real variables
 *
 *******************************************************************************/
...
void assign_mul_add_mul_add_mul_add_mul_r(spinor *const R, spinor *const S, spinor *const U,
                                          spinor *const V, const double c1, const double c2,
                                          const double c3, const double c4, const int N) {
#ifdef TM_USE_OMP
#pragma omp parallel
  {
#endif
