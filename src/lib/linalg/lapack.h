...
void _FT(zgesv)(int* n, int* nrhs, _Complex double a[], int* lda, int ipivot[], _Complex double b[],
                int* ldb, int* info);

extern void _FT(zgeevx)(char* balanc, char* jobvl, char* jobvr, char* sense, int* N,
                        _Complex double A[], int* lda, _Complex double W[], _Complex double vl[],
...
extern void _FT(dsyev)(char* jobz, char* uplo, int* n, double a[], int* lda, double w[],
                       double work[], int* lwork, int* info, int len_jobz, int len_uplo);
extern void _FT(zheev)(char* jobz, char* uplo, int* n, _Complex double a[], int* lda, double w[],
                       _Complex double work[], int* lwork, double* rwork, int* info, int len_jobz,
                       int len_uplo);

extern void _FT(dgetrs)(char* trans, int* n, int* nrhs, double a[], int* lda, int ipiv[],
                        double b[], int* ldb, int* info, int len_trans);
extern void _FT(dgetrf)(int* m, int* n, double a[], int* lda, int ipiv[], int* info);

extern void _FT(zgetrs)(char* trans, int* n, int* nrhs, _Complex double a[], int* lda, int ipiv[],
                        _Complex double b[], int* ldb, int* info, int len_trans);
extern void _FT(zgetrf)(int* m, int* n, _Complex double a[], int* lda, int ipiv[], int* info);

extern void _FT(zhetrs)(char* uplo, int* n, int* nrhs, _Complex double a[], int* lda, int ipiv[],
                        _Complex double b[], int* ldb, int* info, int len_uplo);
...
extern void _FT(dsyevx)(char* jobz, char* range, char* uplo, int* n, double a[], int* lda,
                        double* vl, double* vu, int* il, int* iu, double* abstol, int* m,
                        double w[], double z[], int* ldz, double work[], int* lwork, int iwork[],
                        int ifail[], int* info, int len_jobz, int len_range, int len_uplo);

extern void _FT(zlacpy)(char* UPLO, int* M, int* N, _Complex double* A, int* LDA,
                        _Complex double* B, int* LDB, int len_uplo);
extern void _FT(dlacpy)(char* UPLO, int* M, int* N, double* A, int* LDA, double* B, int* LDB,
                        int len_uplo);

extern void _FT(dlaset)(char* UPLO, int* M, int* N, double* ALPHA, double* BETA, double* A,
                        int* LDA, int len_uplo);
extern void _FT(zlaset)(char* UPLO, int* M, int* N, _Complex double* ALPHA, _Complex double* BETA,
                        _Complex double* A, int* LDA, int len_uplo);

extern double _FT(dlamch)(char* name, int len_name);

extern int _FT(ilaenv)(int* ISPEC, char* NAME, char* OPTS, int* N1, int* N2, int* N3, int* N4,
                       int len_name, int len_opts);

extern void _FT(zgeqrf)(int* M, int* N, _Complex double* A, int* LDA, _Complex double* TAU,
                        _Complex double* WORK, int* LWORK, int* INFO);

extern void _FT(zunmqr)(char* SIDE, char* TRANS, int* M, int* N, int* K, _Complex double* A,
                        int* LDA, _Complex double* TAU, _Complex double* C, int* LDC,
                        _Complex double* WORK, int* LWORK, int* INFO);
#endif
