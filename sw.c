...
for(x=0; x<VOLUME; x++)
  ...
  for(k=0;k<4;k++)
    ...
    for(k=1;k<4;k++) {_su3_assign(electric[k],fkl[0][k]);}
...
/* anti-hermiticity */
  ...
  for(k=0;k<4;k++)
    ...
    for(l=k+1;l<4;l++)
      ...
      _trace_lambda(resu,vv1); der=&dclover[x][k]; _add_su3adj(*der,resu);
      _su3d_times_su3(vv2,*w1,vv1); _su3_times_su3(vv1,vv2,*w1);
      _trace_lambda(resu,vv1); der=&dclover[xpk][l]; _add_su3adj(*der,resu);
 
      _su3_times_su3(vv2,vis[k][l],plaq); _su3_dagger(vv1,vv2);
      _trace_lambda(resu,vv1); der=&dclover[x][l]; _add_su3adj(*der,resu);
      ...
      _su3_dagger(vv1,v1); _su3_times_su3d(vv2,vv1,vis[k][l]);
      _su3_times_su3d(vv1,vv2,v2);
      _trace_lambda(resu,vv1); der=&dclover[xplmk][k]; _add_su3adj(*der,resu);

      _su3_times_su3(vv2,*w3,vv1); _su3_times_su3d(vv1,vv2,*w3);
      _trace_lambda(resu,vv1); der=&dclover[xmk][l]; _add_su3adj(*der,resu);
      ...
      _trace_lambda(resu,vv1); der=&dclover[xmk][k]; _add_su3adj(*der,resu);

      _su3_times_su3(vv2,*w2,vv1); _su3_times_su3d(vv1,vv2,*w2);
      _trace_lambda(resu,vv1); der=&dclover[xmkml][l]; _add_su3adj(*der,resu);

      _su3_dagger(vv2,vv1);
      _trace_lambda(resu,vv2); der=&dclover[xmkml][k]; _add_su3adj(*der,resu);
      ...
      _trace_lambda(resu,vv1); der=&dclover[xml][l]; _add_su3adj(*der,resu);

      _su3_dagger(vv2,vv1);
      _trace_lambda(resu,vv2); der=&dclover[xml][k]; _add_su3adj(*der,resu);

      _su3d_times_su3(vv1,*w2,vv2); _su3_times_su3(vv2,vv1,*w2);
      _trace_lambda(resu,vv2); der=&dclover[xpkml][l]; _add_su3adj(*der,resu);

      _su3_dagger(vv2,v2);  _su3_times_su3d(vv1,vv2,v1);
      _su3_times_su3d(vv2,vv1,vis[k][l]);
      _trace_lambda(resu,vv2); der=&dclover[x][k]; _add_su3adj(*der,resu);
      }
    }
