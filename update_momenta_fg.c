...
void calculate_fg(const double step_fg, hamiltonian_field_t *const hf) {
#ifdef TM_USE_OMP
#define static
#pragma omp parallel
  {
...
void fg_update_momenta_reset_gaugefield(const double step, hamiltonian_field_t *const hf) {
#ifdef TM_USE_OMP
#pragma omp parallel
  {
#endif
