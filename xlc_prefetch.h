...
#define _prefetch_halfspinor(addr) __dcbt(((char*)((unsigned long int)(addr))));

#define _prefetch_spinor(addr)                  \
  __dcbt(((char*)((unsigned long int)(addr)))); \
  __dcbt(((char*)((unsigned long int)(addr))) + 128);

#define _prefetch_spinor_32(addr) __dcbt(((char*)((unsigned long int)(addr))));
// #define _prefetch_spinor_32(addr)

#define _prefetch_su3_32(addr) __dcbt(((char*)((unsigned long int)(addr))));
