static inline void _PTSWITCH(p0add)(_PTSWITCH(spinor) *restrict const tmpr,
                                    _PTSWITCH(spinor) const *restrict const s,
...
static inline void _PTSWITCH(m0add)(_PTSWITCH(spinor) *restrict const tmpr,
                                    _PTSWITCH(spinor) const *restrict const s,
                                    _PSWITCH(su3) const *restrict const u, const _C_TYPE phase) {
#ifdef TM_USE_OMP
#define static
...
static inline void _PTSWITCH(p1add)(_PTSWITCH(spinor) *restrict const tmpr,
                                    _PTSWITCH(spinor) const *restrict const s,
                                    _PSWITCH(su3) const *restrict const u, const _C_TYPE phase) {
#ifdef TM_USE_OMP
#define static
...
static inline void _PTSWITCH(m1add)(_PTSWITCH(spinor) *restrict const tmpr,
                                    _PTSWITCH(spinor) const *restrict const s,
                                    _PSWITCH(su3) const *restrict const u, const _C_TYPE phase) {
#ifdef TM_USE_OMP
#define static
...
static inline void _PTSWITCH(p2add)(_PTSWITCH(spinor) *restrict const tmpr,
                                    _PTSWITCH(spinor) const *restrict const s,
                                    _PSWITCH(su3) const *restrict const u, const _C_TYPE phase) {
#ifdef TM_USE_OMP
#define static
...
static inline void _PTSWITCH(m2add)(_PTSWITCH(spinor) *restrict const tmpr,
                                    _PTSWITCH(spinor) const *restrict const s,
                                    _PSWITCH(su3) const *restrict const u, const _C_TYPE phase) {
#ifdef TM_USE_OMP
#define static
...
static inline void _PTSWITCH(p3add)(_PTSWITCH(spinor) *restrict const tmpr,
                                    _PTSWITCH(spinor) const *restrict const s,
                                    _PSWITCH(su3) const *restrict const u, const _C_TYPE phase) {
#ifdef TM_USE_OMP
#define static
...
static inline void _PTSWITCH(m3addandstore)(_PTSWITCH(spinor) *restrict const r,
                                            _PTSWITCH(spinor) const *restrict const s,
                                            _PSWITCH(su3) const *restrict const u,
                                            const _C_TYPE phase,
...
static inline void _PSWITCH(local_H)(_PTSWITCH(spinor) *const rr, _PTSWITCH(spinor) const *const s,
                                     _PSWITCH(su3) const *restrict u, int *_idx,
                                     _PTSWITCH(spinor) *const restrict tmpr) {
