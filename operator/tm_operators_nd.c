...
void mul_one_pm_iconst(spinor *const l, spinor *const k, const double mu_, const int sign_);

void M_oo_sub_g5_ndpsi(spinor *const l_s, spinor *const l_c, spinor *const k_s, spinor *const k_c,
                       spinor *const j_s, spinor *const j_c, const double mu, const double eps);
 ...
 ******************************************/
void M_full_ndpsi(spinor *const Even_new_s, spinor *const Odd_new_s, spinor *const Even_new_c,
...
void Msw_full_ndpsi(spinor *const Even_new_s, spinor *const Odd_new_s, spinor *const Even_new_c,
                    spinor *const Odd_new_c, spinor *const Even_s, spinor *const Odd_s,
                    spinor *const Even_c, spinor *const Odd_c) {
  double mu = g_mu;
  g_mu = g_mubar;
...
void D_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
             spinor *const k_charm) {
  double mu = g_mu;
  g_mu = g_mubar;
 ...
 * on a half spinor
 ******************************************/
void Qtm_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
               spinor *const k_charm) {
  ...
  M_oo_sub_g5_ndpsi(g_spinor_field[DUM_MATRIX], g_spinor_field[DUM_MATRIX + 1], k_strange, k_charm,
                    l_strange, l_charm, -g_mubar, -g_epsbar);
...
void Qsw_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
               spinor *const k_charm) {
  ...
  assign_mul_one_sw_pm_imu_eps(EE, g_spinor_field[DUM_MATRIX + 2], g_spinor_field[DUM_MATRIX + 3],
                               g_spinor_field[DUM_MATRIX], g_spinor_field[DUM_MATRIX + 1], g_mubar,
                               g_epsbar);
  ...
  clover_gamma5_nd(OO, g_spinor_field[DUM_MATRIX + 2], g_spinor_field[DUM_MATRIX + 3], k_charm,
                   k_strange, g_spinor_field[DUM_MATRIX], g_spinor_field[DUM_MATRIX + 1], g_mubar,
                   -g_epsbar);
...
void Qtm_tau1_ndpsi_add_Ishift(spinor *const l_strange, spinor *const l_charm,
  ...
  Q_tau1_sub_const_ndpsi(l_strange, l_charm, k_strange, k_charm, -I * sqrt(g_shift), 1.,
                         phmc_invmaxev);
...
void Qsw_tau1_ndpsi_add_Ishift(spinor *const l_strange, spinor *const l_charm,
                               spinor *const k_strange, spinor *const k_charm) {
  Qsw_tau1_sub_const_ndpsi(l_strange, l_charm, k_strange, k_charm, -I * sqrt(g_shift), 1.,
                           phmc_invmaxev);
 ...
 * on a half spinor
 ******************************************/
void Qtm_dagger_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                      spinor *const k_charm) {
  /* Here the  M_oe Mee^-1 M_eo  implementation  */
  Hopping_Matrix(EO, g_spinor_field[DUM_MATRIX], k_charm);
  Hopping_Matrix(EO, g_spinor_field[DUM_MATRIX + 1], k_strange);
  ...
  /* Here the M_oo  implementation  */
  M_oo_sub_g5_ndpsi(l_strange, l_charm, k_strange, k_charm, g_spinor_field[DUM_MATRIX + 1],
                    g_spinor_field[DUM_MATRIX], g_mubar, -g_epsbar);
  /* At the end, the normalisation by the max. eigenvalue  */
  mul_r(l_charm, phmc_invmaxev, l_charm, VOLUME / 2);
  mul_r(l_strange, phmc_invmaxev, l_strange, VOLUME / 2);
}

void Qsw_dagger_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                      spinor *const k_charm) {
  Hopping_Matrix(EO, g_spinor_field[DUM_MATRIX], k_charm);
  Hopping_Matrix(EO, g_spinor_field[DUM_MATRIX + 1], k_strange);
 ...
 * on a half spinor
 ******************************************/
void Qtm_pm_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                  spinor *const k_charm) {
  ...
  /* Here the M_oo  implementation  */
  M_oo_sub_g5_ndpsi(g_spinor_field[DUM_MATRIX + 2], g_spinor_field[DUM_MATRIX + 3], k_charm,
                    k_strange, g_spinor_field[DUM_MATRIX], g_spinor_field[DUM_MATRIX + 1], -g_mubar,
                    -g_epsbar);
  ...
  /* Here the M_oo  implementation  */
  M_oo_sub_g5_ndpsi(l_strange, l_charm, g_spinor_field[DUM_MATRIX + 3],
                    g_spinor_field[DUM_MATRIX + 2], l_strange, l_charm, -g_mubar, -g_epsbar);
  /* At the end, the normalisation by the max. eigenvalue  */
...
void Qtm_pm_ndpsi_shift(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                        spinor *const k_charm) {
...
void Qsw_pm_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                  spinor *const k_charm) {
  /* FIRST THE  Qhat(2x2)^dagger  PART*/
  /* Here the  M_oe Mee^-1 M_eo  implementation  */
  Hopping_Matrix(EO, g_spinor_field[DUM_MATRIX], k_charm);
  ...
  assign_mul_one_sw_pm_imu_eps(EE, g_spinor_field[DUM_MATRIX + 7], g_spinor_field[DUM_MATRIX + 6],
                               g_spinor_field[DUM_MATRIX + 1], g_spinor_field[DUM_MATRIX], g_mubar,
                               g_epsbar);
  ...
  clover_gamma5_nd(OO, l_charm, l_strange, g_spinor_field[DUM_MATRIX + 2],
                   g_spinor_field[DUM_MATRIX + 3], g_spinor_field[DUM_MATRIX + 1],
                   g_spinor_field[DUM_MATRIX], g_mubar, -g_epsbar);
...
void Qsw_pm_ndpsi_shift(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                        spinor *const k_charm) {
 ...
 * on a half spinor
 ******************************************/
void Q_tau1_sub_const_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                            spinor *const k_charm, const _Complex double z, const double Cpol,
                            const double invev) {
  spinor *r, *s;
...
void Qsw_tau1_sub_const_ndpsi(spinor *const l_strange, spinor *const l_charm,
  ...
  /* Here the M_oo  implementation  */
  clover_gamma5_nd(OO, g_spinor_field[DUM_MATRIX], g_spinor_field[DUM_MATRIX + 1], k_charm,
                   k_strange, l_strange, l_charm, -g_mubar, -g_epsbar);
...
void H_eo_tm_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                   spinor *const k_charm, const int ieo) {
  ...
  M_ee_inv_ndpsi(l_charm, l_strange, g_spinor_field[DUM_MATRIX], g_spinor_field[DUM_MATRIX + 1],
                 -g_mubar, g_epsbar);
  return;
}

void H_eo_sw_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                   spinor *const k_charm) {
  /* recall:   strange <-> up    while    charm <-> dn   */
  Hopping_Matrix(EO, g_spinor_field[DUM_MATRIX], k_strange);
  Hopping_Matrix(EO, g_spinor_field[DUM_MATRIX + 1], k_charm);

  assign_mul_one_sw_pm_imu_eps(EE, l_charm, l_strange, g_spinor_field[DUM_MATRIX],
                               g_spinor_field[DUM_MATRIX + 1], g_mubar, g_epsbar);
...
void Msw_ee_inv_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                      spinor *const k_charm) {
  /* recall:   strange <-> up    while    charm <-> dn   */
...
void Q_test_epsilon(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                    spinor *const k_charm) {
...
void mul_one_pm_itau2(spinor *const p, spinor *const q, spinor *const r, spinor *const s,
...
void M_ee_inv_ndpsi(spinor *const l_s, spinor *const l_c, spinor *const k_s, spinor *const k_c,
...
void P_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
             spinor *const k_charm) {
  int j;
  ...
  for (j = 0; j < (2 * phmc_dop_n_cheby - 2); j++) {
    ...
    Q_tau1_sub_const_ndpsi(l_strange, l_charm, dum_up, dum_dn, phmc_root[j], phmc_Cpol,
                           phmc_invmaxev);
  }
  return;
}
...
void Qtau1_P_ndpsi(spinor *const l_strange, spinor *const l_charm, spinor *const k_strange,
                   spinor *const k_charm) {
  spinor *dum_up, *dum_dn;
