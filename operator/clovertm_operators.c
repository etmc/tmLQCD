...
void Qsw_pm_psi_32(spinor32 * const l, spinor32 * const k) {
  ...
  clover_inv_32(g_spinor_field32[1], -1, g_mu);
  Hopping_Matrix_32(OE, g_spinor_field32[0], g_spinor_field32[1]);
  clover_gamma5_32(OO, g_spinor_field32[0], k, g_spinor_field32[0], -(g_mu + g_mu3));
  /* \hat Q_{+} */
  Hopping_Matrix_32(EO, l, g_spinor_field32[0]);
  clover_inv_32(l, +1, g_mu); 
  Hopping_Matrix_32(OE, g_spinor_field32[1], l);
  clover_gamma5_32(OO, l, g_spinor_field32[0], g_spinor_field32[1], +(g_mu + g_mu3));
}
