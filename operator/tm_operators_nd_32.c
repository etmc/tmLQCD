...
void sub_epsbar_tau1_32(spinor32 *const l_strange, spinor32 *const l_charm,
...
void Q_pm_ndpsi_32(spinor32 *const l_strange, spinor32 *const l_charm, spinor32 *const k_strange,
                   spinor32 *const k_charm) {
  // D_h^{dagger}
  // tau^1 by s<->c
...
void M_ee_inv_ndpsi_32_orphaned(spinor32 *const l_s, spinor32 *const l_c, spinor32 *const k_s,
                                spinor32 *const k_c, const float mu, const float eps) {
...
void M_ee_inv_ndpsi_32(spinor32 *const l_s, spinor32 *const l_c, spinor32 *const k_s,
                       spinor32 *const k_c, const float mu, const float eps) {
#ifdef TM_USE_OMP
#pragma omp parallel
  {
...
// l_ and k_ are allowed to be the same spinors
void M_oo_sub_g5_ndpsi_32_orphaned(spinor32 *const l_s, spinor32 *const l_c, spinor32 *const k_s,
                                   spinor32 *const k_c, spinor32 *const j_s, spinor32 *const j_c,
...
void M_oo_sub_g5_ndpsi_32(spinor32 *const l_s, spinor32 *const l_c, spinor32 *const k_s,
                          spinor32 *const k_c, spinor32 *const j_s, spinor32 *const j_c,
                          const float mu, const float eps) {
#ifdef TM_USE_OMP
#pragma omp parallel
...
void Qtm_pm_ndpsi_32(spinor32 *const l_strange, spinor32 *const l_charm, spinor32 *const k_strange,
                     spinor32 *const k_charm) {
#ifdef TM_USE_OMP
#pragma omp parallel
  {
    ...
    M_ee_inv_ndpsi_32_orphaned(g_spinor_field32[2], g_spinor_field32[3], g_spinor_field32[0],
                               g_spinor_field32[1], (float)g_mubar, (float)g_epsbar);
    ...
    M_oo_sub_g5_ndpsi_32_orphaned(g_spinor_field32[2], g_spinor_field32[3], k_charm, k_strange,
                                  g_spinor_field32[0], g_spinor_field32[1], (float)(-g_mubar),
                                  (float)(-g_epsbar));
    ...
    M_ee_inv_ndpsi_32_orphaned(g_spinor_field32[5], g_spinor_field32[4], g_spinor_field32[1],
                               g_spinor_field32[0], (float)(-g_mubar), (float)g_epsbar);
...
void Qsw_pm_ndpsi_32(spinor32 *const l_strange, spinor32 *const l_charm, spinor32 *const k_strange,
                     spinor32 *const k_charm) {
#ifdef TM_USE_OMP
#pragma omp parallel
  {
    ...
    assign_mul_one_sw_pm_imu_eps_32_orphaned(EE, g_spinor_field32[2], g_spinor_field32[3],
                                             g_spinor_field32[0], g_spinor_field32[1], -g_mubar,
                                             g_epsbar);
    ...
    // Here the M_oo  implementation
    clover_gamma5_nd_32_orphaned(OO, g_spinor_field32[2], g_spinor_field32[3], k_charm, k_strange,
    ...
    assign_mul_one_sw_pm_imu_eps_32_orphaned(EE, g_spinor_field32[4], g_spinor_field32[5],
                                             g_spinor_field32[1], g_spinor_field32[0], g_mubar,
                                             g_epsbar);
    ...
    clover_gamma5_nd_32_orphaned(OO, l_charm, l_strange, g_spinor_field32[2], g_spinor_field32[3],
