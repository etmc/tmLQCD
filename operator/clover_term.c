...
// sw[x][0][1] the upper off-diagnoal 3x3 matrix
// sw[x][0][2] the lower diagonal 3x3 matrix
// the lower off-diagonal 3x3 matrix would be the inverse of sw[x][0][1]
// 
...
// 
// r_0 = sw[0][0] s_0 + sw[0][1] s_1 + i mu s_0
