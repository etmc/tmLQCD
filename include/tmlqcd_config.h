 ...
 * #undef's PACKAGE PACKAGE_BUGREPORT PACKAGE_NAME PACKAGE_STRING PACKAGE_TARNAME PACKAGE_VERSION
 * VERSION Depending on the include order, either our definitions in tmlqcd_config.h survive, or
 * they do not...
 */
...
// now we include the autoconf-generated header which hopefully correctly sets all the relevant
// macros
