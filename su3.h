...
/* The following should be taken care of by the compiler, actually... Just redefine as
 * _vector_assign */
...
#define _vector_norm_square(r) conj((r).c0) * (r).c0 + conj((r).c1) * (r).c1 + conj((r).c2) * (r).c2
...
#define _su3_norm_sq(x, u)                                                       \
  x = (u).c00 * conj((u).c00) + (u).c01 * conj((u).c01) +                        \
      (u).c02 * conj((u).c02)(u).c10 * conj((u).c10) + (u).c11 * conj((u).c11) + \
      (u).c12 * conj((u).c12)(u).c20 * conj((u).c20) + (u).c21 * conj((u).c21) + \
      (u).c22 * conj((u).c22);
...
#define _trace_su3_times_su3d(x, v, w)                                              \
  x = (v).c00 * conj((w).c00) + (v).c01 * conj((w).c01) + (v).c02 * conj((w).c02) + \
      (v).c10 * conj((w).c10) + (v).c11 * conj((w).c11) + (v).c12 * conj((w).c12) + \
      (v).c20 * conj((w).c20) + (v).c21 * conj((w).c21) + (v).c22 * conj((w).c22);

#define _trace_su3_times_su3(x, v, w)                                                 \
  x = (v).c00 * (w).c00 + (v).c01 * (w).c10 + (v).c02 * (w).c20 + (v).c10 * (w).c01 + \
      (v).c11 * (w).c11 + (v).c12 * (w).c21 + (v).c20 * (w).c02 + (v).c21 * (w).c12 + \
      (v).c22 * (w).c22;
