...
\begin{verbatim}
BeginIntegrator TYPE
  Option = value
EndIntegrator
\end{verbatim}
with the following types available: {\ttfamily 2MN, 2MNPOSITION,
  LEAPFROG} and the following options:
\begin{itemize}
\item {\ttfamily Tau}
...
timescales is $10$ and the cannot be more than $10$ monomials per
timescale. But there can be more that one monomial per timescale.
