...
Parameter sets which are efficient on a particular machine for a particular ensemble may not be very inefficient on another machine or for another ensemble.
