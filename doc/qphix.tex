...
\noindent\textbf{IMPORTANT}: The number of OMP threads controlled by the environment variable \texttt{OMP\_NUM\_THREADS} should be set to \texttt{NCores * Sy * Sz}, otherwise the QPhiX interface will abort execution.
