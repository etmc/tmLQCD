    ...
    for (x1 = 0; x1 < LX; x1++) {
     ...
     defined PARALLELXY || defined PARALLELXYZ)
          ...
          if ((iy0 != iz0) || (iy1 != iz1) || (iy2 != iz2) || (iy3 != iz3) ||
              (g_idn[iy0][0] != ix) || (g_idn[iy1][1] != ix) || (g_idn[iy2][2] != ix) ||
              (g_idn[iy3][3] != ix)) {
     ...
     defined PARALLELXY || defined PARALLELXYZ)
          ...
          if ((iy0 != iz0) || (iy1 != iz1) || (iy2 != iz2) || (iy3 != iz3) ||
              (g_iup[iy0][0] != ix) || (g_iup[iy1][1] != ix) || (g_iup[iy2][2] != ix) ||
              (g_iup[iy3][3] != ix)) {
          ...
          if (x1 == LX - 1) {
            ...
            if (x3 != LZ - 1) {
              ...
              if (itest[iy0] > 1) {
                printf(
                    "Edge +x +z has itest = %d at %d, %d, %d, %d, iy0 = %d iz0 = %d giup[%d][3] = "
                    "%d ix = %d\n",
      ...
      for (x2 = 0; x2 < LY; x2++) {
        for (x3 = 0; x3 < LZ; x3++) {
          ...
          if (iy0 < gI_Lp1_0_0_0 || iy0 >= gI_Lp1_0_0_0 + LX * LY * LZ) {
            printf(
                "The DBW2 boundary is not correctly mapped in up t-direction  %d %d %d %d %d %d\n",
                x0, x1, x2, x3, ix, iy0);
            return (-1);
          }
          itest[iy0]++;
          if (itest[iy0] > 1) {
            printf(
                "The DBW2 boundary is not correctly used itest = %d (%d %d %d %d) iy0 = %d ix = "
                "%d\n",
          ...
          if (iy0 < gI_m2_0_0_0 || iy0 >= gI_m2_0_0_0 + LX * LY * LZ) {
            printf(
                "The DBW2 boundary is not correctly mapped in down t-direction %d %d %d %d %d %d\n",
                x0, x1, x2, x3, ix, iy0);
            return (-1);
          }
          itest[iy0]++;
      ...
      for (x2 = 0; x2 < LY; x2++) {
        for (x3 = 0; x3 < LZ; x3++) {
          ...
          if ((iy1 < gI_0_Lp1_0_0 || iy1 >= gI_0_Lp1_0_0 + T * LY * LZ) && x0 < T) {
            printf(
                "The DBW2 boundary is not correctly mapped in up x-direction %d %d %d %d %d %d\n",
                x0, x1, x2, x3, ix, iy1);
            return (-1);
          }
          itest[iy1]++;
          if (itest[iy1] > 1) {
            printf(
                "The DBW2 boundary is not correctly used up x itest = %d (%d %d %d %d) iy1 = %d ix "
                "= %d \n",
          ...
          if (x0 == T) {
            ...
            if (iy0 < gI_Lp1_L_0_0 || iy0 >= gI_Lp1_L_0_0 + LY * LZ) {
              printf(
                  "The DBW2 boundary is not correctly mapped in up t-direction up x %d %d %d %d %d "
                  "%d\n",
                  x0, x1, x2, x3, ix, iy0);
              return (-1);
            }
            ...
            if (itest[iy0] > 1) {
              printf(
                  "The DBW2 boundary is not correctly used up t up x itest = %d (%d %d %d %d) iy0 "
                  "= %d ix = %d\n",
                  itest[iy0], x0, x1, x2, x3, iy0, ix);
              return (-1);
            }
          ...
          if (x0 == T + 1) {
            ...
            if (iy0 < gI_m2_L_0_0 || iy0 >= gI_m2_L_0_0 + LY * LZ) {
              printf(
                  "The DBW2 boundary is not correctly mapped in down t-direction up x %d %d %d %d "
                  "%d %d\n",
                  x0, x1, x2, x3, ix, iy0);
              return (-1);
            }
            ...
            if (itest[iy0] > 1) {
              printf(
                  "The DBW2 boundary is not correctly used down t up x itest = %d (%d %d %d %d) "
                  "iy0 = %d ix = %d\n",
                  itest[iy0], x0, x1, x2, x3, iy0, ix);
              return (-1);
            }
          ...
          if ((iy1 < gI_0_m2_0_0 || iy1 >= gI_0_m2_0_0 + T * LY * LZ) && x0 < T) {
            printf(
                "The DBW2 boundary is not correctly mapped in down x-direction %d %d %d %d %d %d\n",
                x0, x1, x2, x3, ix, iy1);
            return (-1);
          }
          itest[iy1]++;
          if (itest[iy1] > 1) {
            printf(
                "The DBW2 boundary is not correctly used down x itest = %d (%d %d %d %d) iy1 = %d "
                "ix = %d \n",
                itest[iy1], x0, x1, x2, x3, iy1, ix);
            return (-1);
          }
          ...
          if (x0 == T) {
            ...
            if (iy0 < gI_Lp1_m1_0_0 || iy0 >= gI_Lp1_m1_0_0 + LY * LZ) {
              printf(
                  "The DBW2 boundary is not correctly mapped in up t-direction down x %d %d %d %d "
                  "%d %d\n",
                  x0, x1, x2, x3, ix, iy0);
              return (-1);
            }
            ...
            if (itest[iy0] > 1) {
              printf(
                  "The DBW2 boundary is not correctly used up t down x itest = %d (%d %d %d %d) "
                  "iy0 = %d ix = %d \n",
                  itest[iy0], x0, x1, x2, x3, iy0, ix);
              return (-1);
            }
          ...
          if (x0 == T + 1) {
            ...
            if (iy0 < gI_m2_m1_0_0 || iy0 >= gI_m2_m1_0_0 + LY * LZ) {
              printf(
                  "The DBW2 boundary is not correctly mapped in down t-direction down x %d %d %d "
                  "%d %d %d\n",
                  x0, x1, x2, x3, ix, iy0);
              return (-1);
            }
            ...
            if (itest[iy0] > 1) {
              printf(
                  "The DBW2 boundary is not correctly used down t down xitest = %d (%d %d %d %d) "
                  "iy0 = %d ix = %d \n",
                  itest[iy0], x0, x1, x2, x3, iy0, ix);
              return (-1);
            }
      ...
      for (x1 = 0; x1 < LX + ext_x; x1++) {
        for (x3 = 0; x3 < LZ; x3++) {
          if (x0 < T || x1 < LX) {
            ...
            iy2 = g_iup[ix][2];
            if ((iy2 < gI_0_0_Lp1_0 || iy2 >= gI_0_0_Lp1_0 + T * LX * LZ) && x0 < T && x1 < LX) {
              printf(
                  "The DBW2 boundary is not correctly mapped in up y-direction %d %d %d %d %d %d\n",
                  x0, x1, x2, x3, ix, iy2);
              return (-1);
            }
            itest[iy2]++;
            if (itest[iy2] > 1) {
              printf(
                  "The DBW2 boundary is not correctly used up y itest = %d (%d %d %d %d) iy2 = %d "
                  "ix = %d \n",
            ...
            if (x0 == T && x1 < LX) {
              ...
              if (iy0 < gI_Lp1_0_L_0 || iy0 >= gI_Lp1_0_L_0 + LX * LZ) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up t-direction up y %d %d %d %d "
                    "%d %d\n",
                    x0, x1, x2, x3, ix, iy0);
                return (-1);
              }
              ...
              if (itest[iy0] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used up t up y itest = %d (%d %d %d %d) "
                    "iy0 = %d ix = %d\n",
                    itest[iy0], x0, x1, x2, x3, iy0, ix);
                return (-1);
              }
            ...
            if (x0 == T + 1 && x1 < LX) {
              ...
              if (iy0 < gI_m2_0_L_0 || iy0 >= gI_m2_0_L_0 + LX * LZ) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down t-direction up y %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy0);
                return (-1);
              }
              ...
              if (itest[iy0] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used down t up y itest = %d (%d %d %d %d) "
                    "iy0 = %d ix = %d\n",
                    itest[iy0], x0, x1, x2, x3, iy0, ix);
                return (-1);
              }
            ...
            if (x1 == LX && x0 < T) {
              ...
              if (iy1 < gI_0_Lp1_L_0 || iy1 >= gI_0_Lp1_L_0 + T * LZ) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up x-direction up y %d %d %d %d "
                    "%d %d\n",
                    x0, x1, x2, x3, ix, iy1);
                return (-1);
              }
              ...
              if (itest[iy1] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used x up y up itest = %d (%d %d %d %d) "
                    "iy1 = %d ix = %d\n",
                    itest[iy1], x0, x1, x2, x3, iy1, ix);
                return (-1);
              }
            ...
            if (x1 == LX + 1 && x0 < T) {
              ...
              if (iy1 < gI_0_m2_L_0 || iy1 >= gI_0_m2_L_0 + T * LZ) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down x-direction up y %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy1);
                return (-1);
              }
              ...
              if (itest[iy1] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used x down y up itest = %d (%d %d %d %d) "
                    "iy1 = %d ix = %d\n",
                    itest[iy1], x0, x1, x2, x3, iy1, ix);
                return (-1);
              }
            ...
            ix = g_ipt[x0][x1][x2][x3];
            iy2 = g_idn[ix][2];
            if ((iy2 < gI_0_0_m2_0 || iy2 >= gI_0_0_m2_0 + T * LX * LZ) && x0 < T && x1 < LX) {
              printf(
                  "The DBW2 boundary is not correctly mapped in down y-direction %d %d %d %d %d "
                  "%d\n",
                  x0, x1, x2, x3, ix, iy2);
              return (-1);
            }
            ...
            if (itest[iy2] > 1) {
              printf(
                  "The DBW2 boundary is not correctly used down y itest = %d (%d %d %d %d) iy2 = "
                  "%d ix = %d \n",
                  itest[iy2], x0, x1, x2, x3, iy2, ix);
              return (-1);
            }
            ...
            if (x0 == T && x1 < LX) {
              ...
              if (iy0 < gI_Lp1_0_m1_0 || iy0 >= gI_Lp1_0_m1_0 + LX * LZ) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up t-direction down y %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy0);
                return (-1);
              }
              ...
              if (itest[iy0] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used up t down y itest = %d (%d %d %d %d) "
                    "iy0 = %d ix = %d \n",
                    itest[iy0], x0, x1, x2, x3, iy0, ix);
                return (-1);
              }
            ...
            if (x0 == T + 1 && x1 < LX) {
              ...
              if (iy0 < gI_m2_0_m1_0 || iy0 >= gI_m2_0_m1_0 + LX * LZ) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down t-direction down y %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy0);
                return (-1);
              }
              ...
              if (itest[iy0] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used down t down y itest = %d (%d %d %d "
                    "%d) iy0 = %d ix = %d \n",
                    itest[iy0], x0, x1, x2, x3, iy0, ix);
                return (-1);
              }
            ...
            if (x1 == LX && x0 < T) {
              ...
              if (iy1 < gI_0_Lp1_m1_0 || iy1 >= gI_0_Lp1_m1_0 + T * LZ) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up x-direction down y %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy1);
                return (-1);
              }
              ...
              if (itest[iy1] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used up x down y itest = %d (%d %d %d %d) "
                    "iy1 = %d ix = %d\n",
                    itest[iy1], x0, x1, x2, x3, iy1, ix);
                return (-1);
              }
            ...
            if (x1 == LX + 1 && x0 < T) {
              ...
              if (iy1 < gI_0_m2_m1_0 || iy1 >= gI_0_m2_m1_0 + T * LZ) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down x-direction down y %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy1);
                return (-1);
              }
              ...
              if (itest[iy1] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used down x down y itest = %d (%d %d %d "
                    "%d) iy1 = %d ix = %d\n",
                    itest[iy1], x0, x1, x2, x3, iy1, ix);
                return (-1);
              }
        ...
        for (x2 = 0; x2 < LY + ext_y; x2++) {
          ...
          if (bndcnt < 2) {
            ...
            if (((iy3 < gI_0_0_0_Lp1 || iy3 >= gI_0_0_0_Lp1 + T * LX * LY) && bndcnt == 0) ||
              ...
              printf(
                  "The DBW2 boundary is not correctly mapped in up z-direction %d %d %d %d %d %d\n",
                  x0, x1, x2, x3, ix, iy3);
              return (-1);
            }
            itest[iy3]++;
            if (itest[iy3] > 1) {
              printf(
                  "The DBW2 boundary is not correctly used up z itest = %d (%d %d %d %d) iy3 = %d "
                  "ix = %d \n",
            ...
            if (x0 == T) {
              ...
              if (iy0 < gI_Lp1_0_0_L || iy0 >= gI_Lp1_0_0_L + LX * LY) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up t-direction up z %d %d %d %d "
                    "%d %d\n",
                    x0, x1, x2, x3, ix, iy0);
                return (-1);
              }
              ...
              if (itest[iy0] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used up t up z itest = %d (%d %d %d %d) "
                    "iy0 = %d ix = %d\n",
                    itest[iy0], x0, x1, x2, x3, iy0, ix);
                return (-1);
              }
            ...
            if (x0 == T + 1) {
              ...
              if (iy0 < gI_m2_0_0_L || iy0 >= gI_m2_0_0_L + LX * LY) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down t-direction up z %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy0);
                return (-1);
              }
              ...
              if (itest[iy0] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used down t up z itest = %d (%d %d %d %d) "
                    "iy0 = %d ix = %d\n",
                    itest[iy0], x0, x1, x2, x3, iy0, ix);
                return (-1);
              }
            ...
            if (x1 == LX) {
              ...
              if (iy1 < gI_0_Lp1_0_L || iy1 >= gI_0_Lp1_0_L + T * LY) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up x-direction up z %d %d %d %d "
                    "%d %d\n",
                    x0, x1, x2, x3, ix, iy1);
                return (-1);
              }
              ...
              if (itest[iy1] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used x up z up itest = %d (%d %d %d %d) "
                    "iy1 = %d ix = %d\n",
                    itest[iy1], x0, x1, x2, x3, iy1, ix);
                return (-1);
              }
            ...
            if (x1 == LX + 1) {
              ...
              if (iy1 < gI_0_m2_0_L || iy1 >= gI_0_m2_0_L + T * LY) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down x-direction up z %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy1);
                return (-1);
              }
              ...
              if (itest[iy1] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used x down z up itest = %d (%d %d %d %d) "
                    "iy1 = %d ix = %d\n",
                    itest[iy1], x0, x1, x2, x3, iy1, ix);
                return (-1);
              }
            ...
            if (x2 == LY) {
              ...
              if (iy2 < gI_0_0_Lp1_L || iy2 >= gI_0_0_Lp1_L + T * LX) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up y-direction up z %d %d %d %d "
                    "%d %d\n",
                    x0, x1, x2, x3, ix, iy2);
                return (-1);
              }
              ...
              if (itest[iy2] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used y up z up itest = %d (%d %d %d %d) "
                    "iy2 = %d ix = %d\n",
                    itest[iy2], x0, x1, x2, x3, iy2, ix);
                return (-1);
              }
            ...
            if (x2 == LY + 1) {
              ...
              if (iy2 < gI_0_0_m2_L || iy2 >= gI_0_0_m2_L + T * LX) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down y-direction up z %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy2);
                return (-1);
              }
              ...
              if (itest[iy2] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used y down z up itest = %d (%d %d %d %d) "
                    "iy2 = %d ix = %d\n",
                    itest[iy2], x0, x1, x2, x3, iy2, ix);
                return (-1);
              }
            ...
            if (((iy3 < gI_0_0_0_m2 || iy3 >= gI_0_0_0_m2 + T * LX * LY) && bndcnt == 0) ||
              ...
              printf(
                  "The DBW2 boundary is not correctly mapped in down z-direction %d %d %d %d %d "
                  "%d\n",
                  x0, x1, x2, x3, ix, iy3);
              return (-1);
            }
            ...
            if (itest[iy3] > 1) {
              printf(
                  "The DBW2 boundary is not correctly used down z itest = %d (%d %d %d %d) iy3 = "
                  "%d ix = %d \n",
                  itest[iy3], x0, x1, x2, x3, iy3, ix);
              return (-1);
            }
            ...
            if (x0 == T) {
              ...
              if (iy0 < gI_Lp1_0_0_m1 || iy0 >= gI_Lp1_0_0_m1 + LX * LY) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up t-direction down z %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy0);
                return (-1);
              }
              ...
              if (itest[iy0] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used up t down z itest = %d (%d %d %d %d) "
                    "iy0 = %d ix = %d \n",
                    itest[iy0], x0, x1, x2, x3, iy0, ix);
                return (-1);
              }
            ...
            if (x0 == T + 1) {
              ...
              if (iy0 < gI_m2_0_0_m1 || iy0 >= gI_m2_0_0_m1 + LX * LY) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down t-direction down z %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy0);
                return (-1);
              }
              ...
              if (itest[iy0] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used down t down z itest = %d (%d %d %d "
                    "%d) iy0 = %d ix = %d \n",
                    itest[iy0], x0, x1, x2, x3, iy0, ix);
                return (-1);
              }
            ...
            if (x1 == LX) {
              ...
              if (iy1 < gI_0_Lp1_0_m1 || iy1 >= gI_0_Lp1_0_m1 + T * LY) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up x-direction down z %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy1);
                return (-1);
              }
              ...
              if (itest[iy1] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used up x down z itest = %d (%d %d %d %d) "
                    "iy1 = %d ix = %d\n",
                    itest[iy1], x0, x1, x2, x3, iy1, ix);
                return (-1);
              }
            ...
            if (x1 == LX + 1) {
              ...
              if (iy1 < gI_0_m2_0_m1 || iy1 >= gI_0_m2_0_m1 + T * LY) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down x-direction down z %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy1);
                return (-1);
              }
              ...
              if (itest[iy1] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used down x down z itest = %d (%d %d %d "
                    "%d) iy1 = %d ix = %d\n",
                    itest[iy1], x0, x1, x2, x3, iy1, ix);
                return (-1);
              }
            ...
            if (x2 == LY) {
              ...
              if (iy2 < gI_0_0_Lp1_m1 || iy2 >= gI_0_0_Lp1_m1 + T * LX) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up y-direction down z %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy2);
                return (-1);
              }
              ...
              if (itest[iy2] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used y up z down itest = %d (%d %d %d %d) "
                    "iy2 = %d ix = %d\n",
                    itest[iy2], x0, x1, x2, x3, iy2, ix);
                return (-1);
              }
            ...
            if (x2 == LY + 1) {
              ...
              if (iy2 < gI_0_0_m2_m1 || iy2 >= gI_0_0_m2_m1 + T * LX) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down y-direction down z %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy2);
                return (-1);
              }
              ...
              if (itest[iy2] > 1) {
                printf(
                    "The DBW2 boundary is not correctly used y down z down itest = %d (%d %d %d "
                    "%d) iy2 = %d ix = %d\n",
                    itest[iy2], x0, x1, x2, x3, iy2, ix);
                return (-1);
              }
        ...
        for (x3 = 0; x3 < LZ; x3++) {
          ...
          if (x1 != LX - 1) {
            ...
            if (iy1 < VOLUME + 2 * LX * LY * LZ || iy1 >= VOLUME + 2 * LX * LY * LZ + T * LY * LZ) {
              printf("Boundary for x direction up is wrong %d %d %d\n",
                     iy1 < VOLUME + 2 * LX * LY * LZ,
                     iy1 >= VOLUME + 2 * LX * LY * LZ + T * LY * LZ, iy1);
              return (-1);
            }
          }
#else
          ...
          if (x2 != LY - 1) {
            ...
            iz2 = g_ipt[x0][x1][LY][x3];
            itest[iy2]++;
            if (iy2 < VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ ||
                iy2 >= VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ + T * LX * LZ) {
              printf("Boundary for y direction up is wrong %d %d %d\n",
                     iy2<VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ, iy2> VOLUME +
                         2 * LX * LY * LZ + 2 * T * LY * LZ + T * LX * LZ,
                     iy2);
              return (-1);
            }
          }
          ...
          if (x3 != LZ - 1) {
            ...
            iz3 = g_ipt[x0][x1][x2][LZ];
            itest[iy3]++;
            if (iy3 < VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ + 2 * T * LX * LZ ||
                iy3 >=
                    VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ + 2 * T * LX * LZ + T * LX * LY) {
              printf(
                  "Boundary for z direction up is wrong %d %d %d\n",
                  iy3<VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ + 2 * T * LX * LZ, iy3> VOLUME +
                      2 * LX * LY * LZ + 2 * T * LY * LZ + 2 * T * LX * LZ + T * LX * LY,
                  iy3);
              return (-1);
            }
          }
          ...
          if (x1 != 0) {
            ...
            iz1 = g_ipt[x0][LX + 1][x2][x3];
            itest[iy1]++;
            if (iy1 < VOLUME + 2 * LX * LY * LZ + T * LY * LZ ||
                iy1 >= VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ) {
              printf("Boundary for x direction is wrong %d %d %d\n",
                     iy1 < VOLUME + 2 * LX * LY * LZ + T * LY * LZ,
                     iy1 >= VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ, iy1);
              return (-1);
            }
          }
#else
          ...
          if (x2 != 0) {
            ...
            iz2 = g_ipt[x0][x1][LY + 1][x3];
            itest[iy2]++;
            if (iy2 < VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ + T * LX * LZ ||
                iy2 >= VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ + 2 * T * LX * LZ) {
              printf("Boundary for y direction is wrong %d %d %d\n",
                     iy2 < VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ + T * LX * LZ,
                     iy2 >= VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ + 2 * T * LX * LZ, iy2);
              return (-1);
            }
          }
#else
          ...
          if (x3 != 0) {
            ...
            iz3 = g_ipt[x0][x1][x2][LZ + 1];
            itest[iy3]++;
            if (iy3 < VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ + 2 * T * LX * LZ + T * LX * LY ||
                iy3 >= VOLUME + RAND) {
              printf(
                  "Boundary for z direction is wrong %d %d %d\n",
                  iy3 < VOLUME + 2 * LX * LY * LZ + 2 * T * LY * LZ + 2 * T * LX * LZ + T * LX * LY,
                  iy3 >= VOLUME + RAND, iy3);
              printf("%d %d %d %d %d\n", x0, x1, x2, x3, ix);
              return (-1);
            }
    ...
    for (x0 = 0; x0 < T + 2; x0++) {
      for (x2 = 0; x2 < LY; x2++) {
        for (x3 = 0; x3 < LZ; x3++) {
          ...
          iy1 = g_iup[ix][1];
          if ((iy1 < VOLUMEPLUSRAND + 2 * LX * LY * LZ ||
               iy1 >= VOLUMEPLUSRAND + 2 * LX * LY * LZ + T * LY * LZ) &&
              x0 < T) {
            printf(
                "The DBW2 boundary is not correctly mapped in up x-direction %d %d %d %d %d %d\n",
                x0, x1, x2, x3, ix, iy1);
          ...
          if (x0 == T + 1) {
            iy0 = g_idn[ix][0];
            if (iy0 < VOLUMEPLUSRAND + RAND + 2 * LY * LZ ||
                iy0 >= VOLUMEPLUSRAND + RAND + 3 * LY * LZ) {
              printf(
                  "The DBW2 boundary is not correctly mapped in down t-direction up x %d %d %d %d "
                  "%d %d\n",
                  x0, x1, x2, x3, ix, iy0);
          ...
          iy1 = g_idn[ix][1];
          if ((iy1 < VOLUMEPLUSRAND + 2 * LX * LY * LZ + T * LY * LZ ||
               iy1 >= VOLUMEPLUSRAND + 2 * LX * LY * LZ + 2 * T * LY * LZ) &&
              x0 < T) {
            printf(
                "The DBW2 boundary is not correctly mapped in down x-direction %d %d %d %d %d %d\n",
                x0, x1, x2, x3, ix, iy1);
          ...
          if (x0 == T) {
            iy0 = g_iup[ix][0];
            if (iy0 < VOLUMEPLUSRAND + RAND + LY * LZ ||
                iy0 >= VOLUMEPLUSRAND + RAND + 2 * LY * LZ) {
              printf(
                  "The DBW2 boundary is not correctly mapped in up t-direction down x %d %d %d %d "
                  "%d %d\n",
                  x0, x1, x2, x3, ix, iy0);
          ...
          if (x0 == T + 1) {
            iy0 = g_idn[ix][0];
            if (iy0 < VOLUMEPLUSRAND + RAND + 3 * LY * LZ ||
                iy0 >= VOLUMEPLUSRAND + RAND + 4 * LY * LZ) {
              printf(
                  "The DBW2 boundary is not correctly mapped in down t-direction down x %d %d %d "
                  "%d %d %d\n",
                  x0, x1, x2, x3, ix, iy0);
      ...
      for (x1 = 0; x1 < LX + 2; x1++) {
        for (x3 = 0; x3 < LZ; x3++) {
          if (x0 < T || x1 < LX) {
            ...
            iy2 = g_iup[ix][2];
            if ((iy2 < VOLUMEPLUSRAND + 2 * LX * LY * LZ + 2 * T * LY * LZ ||
                 iy2 >= VOLUMEPLUSRAND + 2 * LX * LY * LZ + 2 * T * LY * LZ + T * LX * LZ) &&
                x0 < T && x1 < LX) {
              printf(
                  "The DBW2 boundary is not correctly mapped in up y-direction %d %d %d %d %d %d\n",
                  x0, x1, x2, x3, ix, iy2);
            ...
            if (x0 == T && x1 < LX) {
              iy0 = g_iup[ix][0];
              if (iy0 < VOLUMEPLUSRAND + RAND + 8 * LY * LZ + 8 * T * LZ ||
                  iy0 >= VOLUMEPLUSRAND + g_dbw2rand) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up t-direction up y %d %d %d %d "
                    "%d %d\n",
                    x0, x1, x2, x3, ix, iy0);
            ...
            ix = g_ipt[x0][x1][x2][x3];
            iy2 = g_idn[ix][2];
            if ((iy2 < VOLUMEPLUSRAND + 2 * LX * LY * LZ + 2 * T * LY * LZ + T * LX * LZ ||
                 iy2 >= VOLUMEPLUSRAND + 2 * LX * LY * LZ + 2 * T * LY * LZ + 2 * T * LX * LZ) &&
                x0 < T && x1 < LX) {
              printf(
                  "The DBW2 boundary is not correctly mapped in down y-direction %d %d %d %d %d "
                  "%d\n",
        ...
        for (x2 = 0; x2 < LY + 2; x2++) {
          ...
          if (bndcnt < 2) {
            ...
            if (((iy3 < VOLUMEPLUSRAND + 2 * LX * LY * LZ + 2 * T * LY * LZ + 2 * T * LX * LZ ||
                  iy3 >= VOLUMEPLUSRAND + 2 * LX * LY * LZ + 2 * T * LY * LZ + 2 * T * LX * LZ +
                             T * LX * LY) &&
                 bndcnt == 0) ||
                (x0 == T && (iy3 < VOLUMEPLUSRAND + RAND + 8 * LY * LZ + 8 * T * LZ + 8 * LX * LZ +
                                       4 * LX * LY ||
                             iy3 >= VOLUMEPLUSRAND + RAND + 8 * LY * LZ + 8 * T * LZ + 8 * LX * LZ +
                                        5 * LX * LY))
                /* 	       ||(x0 == T+1 && (iy3 < VOLUMEPLUSRAND + RAND + 8*LY*LZ + 8*T*LZ +
                   8*LX*LZ + 5*LX*LY || */
                /* 			      iy3 >= VOLUMEPLUSRAND + RAND + 8*LY*LZ + 8*T*LZ +
                   8*LX*LZ + 6*LX*LY)) */
            ) {
              printf(
                  "The DBW2 boundary is not correctly mapped in up z-direction %d %d %d %d %d %d\n",
            ...
            if (x0 == T + 1) {
              ...
              if (iy0 < VOLUMEPLUSRAND + RAND + 8 * LY * LZ + 8 * T * LZ + 8 * LX * LZ + LX * LY ||
                  iy0 >= VOLUMEPLUSRAND + RAND + 8 * LY * LZ + 8 * T * LZ + 8 * LX * LZ +
                             2 * LX * LY) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down t-direction up z %d %d %d "
                    "%d %d %d\n",
            ...
            if (x1 == LX) {
              iy1 = g_iup[ix][1];
              if (iy1 < VOLUMEPLUSRAND + RAND + 8 * LY * LZ + 8 * T * LZ + 8 * LX * LZ +
                            8 * LX * LY + 4 * T * LY ||
                  iy1 >= VOLUMEPLUSRAND + RAND + 8 * LY * LZ + 8 * T * LZ + 8 * LX * LZ +
                             8 * LX * LY + 5 * T * LY) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up x-direction up z %d %d %d %d "
                    "%d %d\n",
            ...
            if (x2 == LY) {
              iy2 = g_iup[ix][2];
              if (iy2 < VOLUMEPLUSRAND + RAND + 8 * LY * LZ + 8 * T * LZ + 8 * LX * LZ +
                            8 * LX * LY + 8 * T * LY + 4 * T * LX ||
                  iy2 >= VOLUMEPLUSRAND + RAND + 8 * LY * LZ + 8 * T * LZ + 8 * LX * LZ +
                             8 * LX * LY + 8 * T * LY + 5 * T * LX) {
                printf(
                    "The DBW2 boundary is not correctly mapped in up y-direction up z %d %d %d %d "
                    "%d %d\n",
                    x0, x1, x2, x3, ix, iy2);
            ...
            if (x2 == LY + 1) {
              iy2 = g_idn[ix][2];
              if (iy2 < VOLUMEPLUSRAND + RAND + 8 * LY * LZ + 8 * T * LZ + 8 * LX * LZ +
                            8 * LX * LY + 8 * T * LY + 6 * T * LX ||
                  iy2 >= VOLUMEPLUSRAND + RAND + 8 * LY * LZ + 8 * T * LZ + 8 * LX * LZ +
                             8 * LX * LY + 8 * T * LY + 7 * T * LX) {
                printf(
                    "The DBW2 boundary is not correctly mapped in down y-direction up z %d %d %d "
                    "%d %d %d\n",
                    x0, x1, x2, x3, ix, iy2);
